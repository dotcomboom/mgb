package
{
   ...
   public class ToolButton extends Button implements IBindingClient
   {
      ...
      {
         ToolButton._watcherSetupUtil = param1;
      }
      ...
      private function _ToolButton_bindingExprs() : void
      {
      ...
      {
         var i:uint;
         var target:ToolButton = null;
         var watcherSetupUtilClass:Object = null;
         var bindings:Array = _ToolButton_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_ToolButtonWatcherSetupUtil");
      ...
      private function _ToolButton_Glow1_i() : Glow
      {
      ...
      private function _ToolButton_bindingsSetup() : Array
      {
