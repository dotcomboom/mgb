package mx.preloaders
{
   ...
   public class DownloadProgressBar extends Sprite implements IPreloaderDisplay
   {
      ...
      protected function createChildren() : void
      {
         ...
         var _loc5_:Matrix;
         (_loc5_ = new Matrix()).createGradientBox(_barFrameRect.width,_barFrameRect.height,Math.PI / 2,calcX(_barFrameRect.x),calcY(_barFrameRect.y));
      ...
      private function drawProgressBar(param1:Number) : void
      {
         ...
         var _loc6_:Number;
         var _loc7_:Number = (_loc6_ = _barRect.width * param1 / 100) / 2;
...
class ErrorField extends Sprite
{
   ...
   public function show(param1:String) : void
   {
      ...
      var _loc2_:Number = Number(downloadProgressBar.stageWidth);
      var _loc3_:Number = Number(downloadProgressBar.stageHeight);
