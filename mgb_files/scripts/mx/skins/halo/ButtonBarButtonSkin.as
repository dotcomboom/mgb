package mx.skins.halo
{
   ...
   public class ButtonBarButtonSkin extends Border
   {
      ...
      private static function isButtonBar(param1:Object) : Boolean
      {
         ...
         xmllist = x.extendsClass.(@type == "mx.controls::ButtonBar");
         if(xmllist.length() == 0)
         {
            bbars[s] = 0;
            return false;
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         {
            _loc12_ = Boolean((parent as IButton).emphasized);
         }
         var _loc14_:Object = Boolean(parent) && Boolean(parent.parent) && isButtonBar(parent.parent) ? parent.parent : null;
         ...
         if(_loc14_)
         {
            ...
            _loc16_ = (_loc22_ = int(_loc14_.getChildIndex(parent))) == 0 ? -1 : (_loc22_ == _loc14_.numChildren - 1 ? 1 : 0);
         }
