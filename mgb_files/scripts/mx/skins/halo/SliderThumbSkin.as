package mx.skins.halo
{
   ...
   public class SliderThumbSkin extends Border
   {
      ...
      protected function drawThumbState(param1:Number, param2:Number, param3:Array, param4:Array, param5:Array, param6:Boolean, param7:Boolean) : void
      {
         ...
         var _loc9_:Boolean;
         var _loc10_:Number = (_loc9_ = getStyle("invertThumbDirection")) ? param2 : 0;
         var _loc11_:Number = _loc9_ ? param2 - 1 : 1;
         var _loc12_:Number = _loc9_ ? param2 - 2 : 2;
         var _loc13_:Number = _loc9_ ? 2 : param2 - 2;
         var _loc14_:Number = _loc9_ ? 1 : param2 - 1;
         var _loc15_:Number = _loc9_ ? 0 : param2;
         if(_loc9_)
         {
