   ...
   public class WipeDownInstance extends MaskEffectInstance
   {
      ...
      override protected function initMaskEffect() : void
      {
         ...
         if(showTarget)
         {
            ...
            yTo = effectMask.height <= _loc1_ ? _loc1_ - effectMask.height + targetVisualBounds.y : targetVisualBounds.y;
         }
         else
         {
            xFrom = targetVisualBounds.x;
            yFrom = effectMask.height <= _loc1_ ? targetVisualBounds.y : _loc1_ - effectMask.height + targetVisualBounds.y;
            xTo = targetVisualBounds.x;
