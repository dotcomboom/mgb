package mx.effects.effectClasses
{
   ...
   public class ResizeInstance extends TweenEffectInstance
   {
      ...
      private function hidePanelChildren() : Boolean
      {
         ...
         var _loc1_:int = int(hideChildrenTargets.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      override mx_internal function eventHandler(param1:Event) : void
      {
         ...
         else if(param1.type == EffectEvent.EFFECT_END)
         {
            ...
            _loc3_ = int(hideChildrenTargets.length);
            _loc4_ = 0;
            while(_loc4_ < _loc3_)
            {
      ...
      private function restorePanelChildren() : void
      {
         ...
         if(hideChildrenTargets)
         {
            _loc1_ = int(hideChildrenTargets.length);
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = hideChildrenTargets[_loc2_];
               ...
               if(restoreAutoLayoutArray[_loc2_])
               {
      ...
      override public function onTweenEnd(param1:Object) : void
      {
         ...
         if(!heightSet)
         {
            ...
            if(parentOrigVerticalScrollPolicy != "" && Boolean(target.parent))
            {
         ...
         if(!widthSet)
         {
            ...
            if(parentOrigHorizontalScrollPolicy != "" && Boolean(target.parent))
            {
               _loc3_ = target.parent as Container;
               if(_loc3_)
               {
