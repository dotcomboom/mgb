package mx.effects
{
   ...
   public class Effect extends EventDispatcher implements IEffect
   {
      ...
      public function stop() : void
      {
         ...
         var _loc1_:int = int(_instances.length);
      ...
      public function deleteInstance(param1:IEffectInstance) : void
      {
         ...
         var _loc2_:int = int(_instances.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      {
         return Boolean(_instances) && _instances.length > 0;
      }
      ...
      public function createInstance(param1:Object = null) : IEffectInstance
      {
         ...
         if(_loc4_)
         {
            ...
            if(_loc5_)
            {
               _loc6_ = int(mx_internal::propertyChangesArray.length);
               _loc7_ = 0;
               while(_loc7_ < _loc6_)
               {
      ...
      mx_internal function applyStartValues(param1:Array, param2:Array) : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            if(_loc9_)
            {
               ...
               _loc6_ = int(relevantStyles.length);
               _loc7_ = 0;
               while(_loc7_ < _loc6_)
               {
