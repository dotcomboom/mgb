package mx.effects
{
   ...
   public class CompositeEffect extends Effect
   {
      ...
      override mx_internal function captureValues(param1:Array, param2:Boolean) : Array
      {
         ...
         while(_loc4_ < _loc3_)
         {
            param1 = (_loc5_ = children[_loc4_]).mx_internal::captureValues(param1,param2);
            _loc4_++;
         }
         return param1;
      }
      ...
      override mx_internal function applyStartValues(param1:Array, param2:Array) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            _loc6_ = (_loc5_ = children[_loc4_]).targets.length > 0 ? _loc5_.targets : param2;
      ...
      private function getChildrenTargets() : Array
      {
         ...
         while(_loc6_ < _loc5_)
         {
            if((_loc4_ = children[_loc6_]) is CompositeEffect)
            {
