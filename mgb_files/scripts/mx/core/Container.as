package mx.core
{
   ...
   public class Container extends UIComponent implements IContainer, IDataRenderer, IFocusManagerContainer, IListItemRenderer, IRawChildrenContainer
   {
      ...
      {
         return Boolean(mx_internal::border) && mx_internal::border is IRectangularBorder ? IRectangularBorder(mx_internal::border).borderMetrics : EdgeMetrics.EMPTY;
      }
      ...
      override public function removeChild(param1:DisplayObject) : DisplayObject
      {
         ...
         if(param1 is IDeferredInstantiationUIComponent && Boolean(IDeferredInstantiationUIComponent(param1).descriptor))
         {
            ...
            {
               _loc2_ = int(mx_internal::createdComponents.length);
               _loc3_ = 0;
               while(_loc3_ < _loc2_)
               {
      ...
      {
         var _loc2_:Rectangle = Boolean(mx_internal::contentPane) && Boolean(mx_internal::contentPane.scrollRect) ? mx_internal::contentPane.scrollRect : null;
         if(_loc2_)
         {
            mx_internal::contentPane.scrollRect = null;
         }
