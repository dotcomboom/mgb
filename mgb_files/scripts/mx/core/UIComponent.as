   ...
   public class UIComponent extends FlexSprite implements IAutomationObject, IChildList, IDeferredInstantiationUIComponent, IFlexDisplayObject, IFlexModule, IInvalidating, ILayoutManagerClient, IPropertyChangeNotifier, IRepeaterClient, ISimpleStyleClient, IStyleClient, IToolTipManagerClient, IUIComponent, IValidatorListener, IStateClient, IConstraintClient
   {
      ...
      public function invalidateDisplayList() : void
      {
         if(!mx_internal::invalidateDisplayListFlag)
         {
            ...
            if(isOnDisplayList() && Boolean(UIComponentGlobals.mx_internal::layoutManager))
            {
      ...
      public function hasFontContextChanged() : Boolean
      {
         ...
         var _loc6_:EmbeddedFont = mx_internal::getEmbeddedFont(_loc1_,_loc4_,_loc5_);
         var _loc7_:IFlexModuleFactory;
      ...
      public function determineTextFormatFromStyles() : UITextFormat
      {
         ...
         if(!_loc1_)
         {
            ...
            _loc1_ = new UITextFormat(mx_internal::getNonNullSystemManager(),_loc2_);
      ...
      private function processEffectFinished(param1:Array) : void
      {
         ...
         var _loc9_:int = 0;
         var _loc2_:int = int(mx_internal::_effectsStarted.length - 1);
         while(_loc2_ >= 0)
         {
            _loc3_ = 0;
      ...
      public function set moduleFactory(param1:IFlexModuleFactory) : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if(_loc4_ = getChildAt(_loc3_) as UIComponent)
            {
      ...
      mx_internal function updateCallbacks() : void
      {
         ...
         if(Boolean(systemManager) && (_systemManager.stage || _systemManager.useSWFBridge()))
         {
      ...
      {
         var _loc1_:int = int(mx_internal::_effectsStarted.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      {
         if(!mx_internal::_errorString || mx_internal::_errorString.length == 0)
         {
