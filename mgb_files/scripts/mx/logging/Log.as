package mx.logging
{
   ...
   public class Log
   {
      ...
      public static function addTarget(param1:ILoggingTarget) : void
      {
         ...
         _loc5_ = String(resourceManager.getString("logging","invalidTarget"));
      ...
      private static function checkCategory(param1:String) : void
      {
         ...
         {
            _loc2_ = String(resourceManager.getString("logging","invalidLen"));
            throw new InvalidCategoryError(_loc2_);
         }
         if(hasIllegalCharacters(param1) || param1.indexOf("*") != -1)
         {
            _loc2_ = String(resourceManager.getString("logging","invalidChars"));
            throw new InvalidCategoryError(_loc2_);
         }
      }
      ...
      public static function removeTarget(param1:ILoggingTarget) : void
      {
         ...
         _loc6_ = String(resourceManager.getString("logging","invalidTarget"));
