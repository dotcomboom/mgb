package mx.formatters
{
   ...
   public class NumberFormatter extends Formatter
   {
      ...
      public function set thousandsSeparatorTo(param1:String) : void
      {
         ...
         _thousandsSeparatorTo = param1 != null ? param1 : String(resourceManager.getString("SharedResources","thousandsSeparatorTo"));
      }
      ...
      public function set decimalSeparatorTo(param1:String) : void
      {
         ...
         _decimalSeparatorTo = param1 != null ? param1 : String(resourceManager.getString("SharedResources","decimalSeparatorTo"));
      }
      ...
      override public function format(param1:Object) : String
      {
         ...
         if(Boolean(useThousandsSeparator) && (decimalSeparatorFrom == thousandsSeparatorFrom || decimalSeparatorTo == thousandsSeparatorTo))
         {
         ...
         var _loc4_:String;
         (_loc4_ = String(param1.toString())).toLowerCase();
         var _loc5_:int;
         ...
         var _loc6_:Array;
         var _loc7_:int = !!(_loc6_ = _loc4_.split("."))[1] ? String(_loc6_[1]).length : 0;
         if(precision <= _loc7_)
         {
      ...
      public function set rounding(param1:String) : void
      {
         ...
         _rounding = param1 != null ? param1 : String(resourceManager.getString("formatters","rounding"));
      }
      ...
      public function set thousandsSeparatorFrom(param1:String) : void
      {
         ...
         _thousandsSeparatorFrom = param1 != null ? param1 : String(resourceManager.getString("SharedResources","thousandsSeparatorFrom"));
      }
      ...
      public function set decimalSeparatorFrom(param1:String) : void
      {
         ...
         _decimalSeparatorFrom = param1 != null ? param1 : String(resourceManager.getString("SharedResources","decimalSeparatorFrom"));
      }
