package mx.managers
{
   ...
   public class ToolTipManagerImpl extends EventDispatcher implements IToolTipManager2
   {
      ...
      public function createToolTip(param1:String, param2:Number, param3:Number, param4:String = null, param5:IUIComponent = null) : IToolTip
      {
         ...
         (_loc7_ = !!param5 ? param5.systemManager as ISystemManager : ApplicationGlobals.application.systemManager as ISystemManager).topLevelSystemManager.addChildToSandboxRoot("toolTipChildren",_loc6_ as DisplayObject);
         if(param4)
         {
      ...
      mx_internal function positionTip() : void
      {
         ...
         else
         {
            ...
            _loc9_ = Number(currentToolTip.width);
            if(_loc1_ + _loc9_ > _loc3_)
            {
               _loc1_ = _loc3_ - _loc9_;
            }
            _loc10_ = Number(currentToolTip.height);
