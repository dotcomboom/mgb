package mx.managers
{
   ...
   public class FocusManager implements IFocusManager
   {
      ...
      private function defaultButtonKeyHandler(param1:KeyboardEvent) : void
      {
         ...
         if(defaultButtonEnabled && param1.keyCode == Keyboard.ENTER && defaultButton && Boolean(defButton.enabled))
         {
      ...
      private function findFocusManagerComponent2(param1:InteractiveObject) : DisplayObject
      {
         ...
         try
         {
            while(o)
            {
               if(o is IFocusManagerComponent && Boolean(IFocusManagerComponent(o).focusEnabled) || o is ISWFLoader)
               {
                  return o;
               }
               o = o.parent;
      ...
      private function removedHandler(param1:Event) : void
      {
         ...
         if((Boolean(_loc4_ = !!focusPane ? focusPane.parent : null)) && _loc3_ != focusPane)
         {
