package mx.resources
{
   ...
   public class ResourceBundle implements IResourceBundle
   {
      ...
      public static function getResourceBundle(param1:String, param2:ApplicationDomain = null) : ResourceBundle
      {
         ...
         if(!(_loc4_ = getClassByName(_loc3_,param2)))
         {
         ...
         {
            _loc3_ = param1 + "_properties";
            if(!(_loc4_ = getClassByName(_loc3_,mx_internal::backupApplicationDomain)))
            {
               _loc3_ = param1;
         ...
         if(_loc4_)
         {
            if((_loc5_ = new _loc4_()) is ResourceBundle)
            {
      ...
      {
         var _loc3_:String = String(_getObject(param1).toLowerCase());
         if(_loc3_ == "false")
         {
            return false;
         }
