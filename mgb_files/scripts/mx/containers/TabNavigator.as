package mx.containers
{
   ...
   public class TabNavigator extends ViewStack implements IFocusManagerComponent
   {
      ...
      override protected function layoutChrome(param1:Number, param2:Number) : void
      {
         ...
         {
            _loc3_ = tabBarHeight;
            mx_internal::border.setActualSize(param1,param2 - _loc3_);
            mx_internal::border.move(0,_loc3_);
         }
      }
      ...
      override protected function commitProperties() : void
      {
         ...
         if(tabBar && tabBar.dataProvider != this && numChildren > 0 && Boolean(getChildAt(0)))
         {
      ...
      override protected function adjustFocusRect(param1:DisplayObject = null) : void
      {
         ...
         var _loc2_:IFlexDisplayObject = IFlexDisplayObject(mx_internal::getFocusObject());
         if(_loc2_)
         {
      ...
      override protected function measure() : void
      {
         ...
         if(Boolean(mx_internal::vsPreferredWidth) && !resizeToContent)
         {
         ...
         _loc3_ += _loc4_.left + _loc4_.right;
         if(numChildren > 1)
         {
            _loc3_ += getStyle("horizontalGap") * (numChildren - 1);
         }
         ...
         mx_internal::vsMinWidth = measuredMinWidth;
         mx_internal::vsMinHeight = measuredMinHeight;
         mx_internal::vsPreferredWidth = measuredWidth;
         mx_internal::vsPreferredHeight = measuredHeight;
      }
      ...
      override public function drawFocus(param1:Boolean) : void
      {
         ...
         if(param1 && !mx_internal::isEffectStarted)
         {
            if(_loc2_)
            {
               ...
               {
                  _loc3_ = int(Container(parent).rawChildren.numChildren);
                  _loc4_ = Container(parent).mx_internal::firstChildIndex;
                  Container(parent).rawChildren.setChildIndex(_loc2_,Math.max(0,_loc4_ == _loc3_ ? _loc3_ - 1 : _loc4_));
               }
               else
               {
