package mx.containers
{
   ...
   public class GridRow extends HBox
   {
      ...
      internal var columnWidths:Array;
      
      internal var rowHeights:Array;
      ...
      internal function doRowLayout(param1:Number, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = Boolean(mx_internal::invalidateSizeFlag);
         var _loc5_:Boolean = Boolean(mx_internal::invalidateDisplayListFlag);
         ...
         while(_loc7_ < _loc3_)
         {
            _loc9_ = (_loc8_ = GridItem(getChildAt(_loc7_))).colIndex;
            _loc10_ = Number(columnWidths[_loc9_].x);
            _loc11_ = _loc6_.top;
            _loc12_ = _loc8_.percentHeight;
            _loc13_ = Math.min(_loc9_ + _loc8_.colSpan,columnWidths.length);
            _loc15_ = (_loc14_ = columnWidths[_loc13_ - 1]).x + _loc14_.width - _loc10_;
            _loc16_ = Math.min(rowIndex + _loc8_.rowSpan,rowHeights.length);
            _loc18_ = (_loc17_ = rowHeights[_loc16_ - 1]).y + _loc17_.height - rowHeights[rowIndex].y - _loc6_.top - _loc6_.bottom;
            if((_loc19_ = _loc15_ - _loc8_.maxWidth) > 0)
            {
               _loc10_ += _loc19_ * mx_internal::layoutObject.mx_internal::getHorizontalAlignValue();
               _loc15_ -= _loc19_;
            }
            ...
            if(_loc19_ > 0)
            {
               _loc11_ = _loc19_ * mx_internal::layoutObject.mx_internal::getVerticalAlignValue();
               _loc18_ -= _loc19_;
            }
         ...
         mx_internal::invalidateSizeFlag = _loc4_;
         mx_internal::invalidateDisplayListFlag = _loc5_;
      }
      ...
      private function calculateColumnWidths() : void
      {
         ...
         var _loc3_:int = int(columnWidths.length);
         ...
         while(_loc8_ < _loc3_)
         {
            if(_loc11_ = (_loc6_ = columnWidths[_loc8_]).percent)
            {
               _loc9_ += _loc11_;
               _loc10_.push(_loc6_);
            }
         ...
         _loc7_ = _loc1_.left + _loc5_ * mx_internal::layoutObject.mx_internal::getHorizontalAlignValue();
         _loc8_ = 0;
         while(_loc8_ < _loc3_)
         {
            (_loc6_ = columnWidths[_loc8_]).x = _loc7_;
      ...
      internal function updateRowMeasurements() : void
      {
         ...
         while(_loc4_ < _loc1_)
         {
            ...
            _loc2_ += _loc8_.min;
            _loc3_ += _loc8_.preferred;
            _loc4_++;
         }
         var _loc5_:Number = Number(mx_internal::layoutObject.mx_internal::widthPadding(_loc1_));
         _loc6_ = Number(mx_internal::layoutObject.mx_internal::heightPadding(0));
