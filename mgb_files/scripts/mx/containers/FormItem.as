package mx.containers
{
   ...
   public class FormItem extends Container
   {
      ...
      {
         mx_internal::verticalLayoutObject = new BoxLayout();
         super();
      ...
      override public function styleChanged(param1:String) : void
      {
         ...
         if(_loc2_ || param1 == "labelStyleName")
         {
            if(labelObj)
            {
               ...
               if(_loc3_)
               {
                  if(_loc4_ = StyleManager.getStyleDeclaration("." + _loc3_))
                  {
      ...
      private function calcNumColumns(param1:Number) : int
      {
         ...
         {
            if(!(_loc7_ = IUIComponent(getChildAt(_loc6_))).includeInLayout)
            {
               _loc5_--;
            }
            else
      ...
      private function previousUpdateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         var _loc17_:int;
         if((_loc17_ = numChildren) > 0)
         {
            _loc12_ = Number((_loc11_ = IUIComponent(getChildAt(0))).baselinePosition);
            if(!isNaN(_loc12_))
            {
               _loc6_ += _loc12_ - labelObj.baselinePosition;
            }
         }
         ...
         _loc4_ += _loc8_;
         var _loc18_:Number;
         if((_loc18_ = param1 - _loc3_.right - _loc4_) < 0)
         {
            _loc18_ = 0;
         }
         if(direction == FormItemDirection.HORIZONTAL)
         {
            ...
            if(_loc20_ == _loc17_)
            {
               ...
               _loc4_ += _loc24_ * _loc16_;
               _loc10_ = 0;
               while(_loc10_ < _loc17_)
               {
                  (_loc11_ = IUIComponent(getChildAt(_loc10_))).move(Math.floor(_loc4_),_loc5_);
                  _loc4_ += _loc11_.width + _loc14_;
                  _loc10_++;
               }
            }
            else
            {
               ...
               if((_loc25_ = _loc18_ - (_loc20_ * _loc19_ + (_loc20_ - 1) * _loc14_)) < 0)
               {
                  _loc25_ = 0;
               }
               _loc21_ = _loc4_ += _loc25_ * _loc16_;
               _loc10_ = 0;
               while(_loc10_ < _loc17_)
               {
                  _loc11_ = IUIComponent(getChildAt(_loc10_));
                  ...
                  if(++_loc22_ >= _loc20_)
                  {
                     _loc21_ = _loc4_;
                     _loc22_ = 0;
                     _loc5_ += _loc11_.height + _loc15_;
                  }
                  else
                  {
                     _loc21_ += _loc19_ + _loc14_;
                  }
                  _loc10_++;
               }
            }
         ...
         else
         {
            ...
            while(_loc10_ < _loc17_)
            {
               ...
               {
                  _loc13_ = Number(_loc11_.getExplicitOrMeasuredWidth());
      ...
      private function previousMeasure() : void
      {
         ...
         while(_loc16_ < _loc15_)
         {
            ...
            if(_loc5_ < _loc1_)
            {
               _loc6_ += !isNaN(_loc17_.percentWidth) ? _loc17_.minWidth : _loc17_.getExplicitOrMeasuredWidth();
               _loc7_ += _loc14_ > 0 ? _loc14_ : _loc17_.getExplicitOrMeasuredWidth();
               if(_loc5_ > 0)
               {
                  _loc6_ += _loc2_;
                  _loc7_ += _loc2_;
         ...
         _loc11_ += _loc19_.top + _loc19_.bottom;
         _loc10_ += _loc19_.left + _loc19_.right;
         _loc13_ += _loc19_.top + _loc19_.bottom;
         _loc12_ += _loc19_.left + _loc19_.right;
      ...
      private function measureHorizontal() : void
      {
         ...
         if(_loc1_ < numChildren)
         {
            ...
            {
               if((_loc16_ = IUIComponent(getChildAt(_loc14_))).includeInLayout)
               {
         ...
         while(_loc14_ < numChildren)
         {
            if((_loc16_ = IUIComponent(getChildAt(_loc14_))).includeInLayout)
            {
               _loc5_ += !isNaN(_loc16_.percentWidth) ? _loc16_.minWidth : _loc16_.getExplicitOrMeasuredWidth();
               _loc6_ += _loc13_ > 0 ? _loc13_ : _loc16_.getExplicitOrMeasuredWidth();
               if(_loc15_ > 0)
               {
                  _loc5_ += _loc2_;
                  _loc6_ += _loc2_;
         ...
         var _loc19_:EdgeMetrics = viewMetricsAndPadding;
         _loc10_ += _loc19_.top + _loc19_.bottom;
         _loc9_ += _loc19_.left + _loc19_.right;
         _loc12_ += _loc19_.top + _loc19_.bottom;
         _loc11_ += _loc19_.left + _loc19_.right;
      ...
      private function updateDisplayListVerticalChildren(param1:Number, param2:Number) : void
      {
         ...
         {
            mx_internal::_explicitMinWidth -= _loc3_;
         }
         else if(!isNaN(measuredMinWidth))
         {
            measuredMinWidth -= _loc3_;
         }
         mx_internal::verticalLayoutObject.updateDisplayList(param1 - _loc3_,param2);
         if(!isNaN(explicitMinWidth))
         {
            mx_internal::_explicitMinWidth += _loc3_;
         }
      ...
      private function updateDisplayListHorizontalChildren(param1:Number, param2:Number) : void
      {
         ...
         var _loc10_:Number = mx_internal::getHorizontalAlignValue();
         var _loc11_:Number = scaleX > 0 && scaleX != 1 ? minWidth / Math.abs(scaleX) : minWidth;
         var _loc12_:Number = scaleY > 0 && scaleY != 1 ? minHeight / Math.abs(scaleY) : minHeight;
         ...
         var _loc16_:Number;
         if((_loc16_ = _loc13_ - _loc4_ - _loc5_) < 0)
         {
            _loc16_ = 0;
         }
         ...
         if(_loc21_ == _loc31_)
         {
            ...
            _loc23_ += _loc32_ * _loc10_;
            _loc17_ = 0;
            while(_loc17_ < numChildren)
            {
               if((_loc18_ = IUIComponent(getChildAt(_loc17_))).includeInLayout)
               {
                  _loc18_.move(Math.floor(_loc23_),_loc24_);
                  _loc23_ += _loc18_.width + _loc6_;
               }
               _loc17_++;
            }
         }
         else
         {
            ...
            while(_loc17_ < numChildren)
            {
               if((_loc18_ = IUIComponent(getChildAt(_loc17_))).includeInLayout)
               {
                  _loc27_ = Number(_loc18_.getExplicitOrMeasuredWidth());
                  _loc29_ = Number(_loc18_.percentWidth);
                  _loc19_ = !isNaN(_loc29_) ? _loc29_ * _loc16_ / 100 : _loc27_;
            ...
            if((_loc33_ = _loc16_ - (_loc21_ * _loc15_ + (_loc21_ - 1) * _loc6_)) < 0)
            {
               _loc33_ = 0;
            }
            _loc23_ += _loc33_ * _loc10_;
            _loc34_ = 0;
            _loc35_ = 0;
            _loc36_ = 0;
            _loc38_ = _loc37_ = _loc14_;
            _loc22_ = 0;
            _loc17_ = 0;
            while(_loc17_ < numChildren)
            {
            ...
            if((_loc41_ = _loc38_ - _loc37_ * _loc36_ / 100) > 0)
            {
               _loc38_ -= _loc41_;
            }
            do
            {
               ...
               while(_loc17_ < numChildren)
               {
                  ...
                  {
                     _loc27_ = Number(_loc18_.getExplicitOrMeasuredWidth());
                     _loc28_ = Number(_loc18_.getExplicitOrMeasuredHeight());
                     _loc29_ = Number(_loc18_.percentWidth);
                     _loc30_ = Number(_loc18_.percentHeight);
                     _loc19_ = Math.min(_loc15_,!isNaN(_loc29_) ? _loc29_ * _loc16_ / 100 : _loc27_);
                     _loc19_ = Math.max(_loc18_.minWidth,Math.min(_loc18_.maxWidth,_loc19_));
                     if(_loc40_[_loc17_] != -1)
                     {
                        _loc20_ = Number(_loc40_[_loc17_]);
                     }
                     else
                     {
                        if((_loc20_ = !isNaN(_loc30_) ? _loc30_ * _loc42_ : _loc28_) < _loc18_.minHeight)
                        {
                           _loc20_ = Number(_loc18_.minHeight);
                           _loc36_ -= _loc18_.percentHeight;
                           _loc38_ -= _loc20_;
                     ...
                     if(++_loc22_ >= _loc21_)
                     {
                        _loc25_ = _loc23_;
                        _loc22_ = 0;
                        _loc26_ += _loc43_ + _loc7_;
                        _loc43_ = 0;
                     }
                     else
                     {
                        _loc25_ += _loc15_ + _loc6_;
                     }
                  }
                  _loc17_++;
               }
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(numChildren > 0)
         {
            _loc8_ = Number((_loc7_ = IUIComponent(getChildAt(0))).baselinePosition);
            if(!isNaN(_loc8_))
            {
               _loc5_ += _loc8_ - labelObj.baselinePosition;
            }
         }
      ...
      private function measureVertical() : void
      {
         ...
         mx_internal::verticalLayoutObject.measure();
