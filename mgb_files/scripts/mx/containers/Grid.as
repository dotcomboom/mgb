package mx.containers
{
   ...
   public class Grid extends Box
   {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         {
            if((_loc5_ = GridRow(getChildAt(_loc7_))).includeInLayout)
            {
               _loc6_.push(_loc5_);
               _loc3_++;
            }
      ...
      private function distributeItemWidth(param1:GridItem, param2:int, param3:Number, param4:Array) : void
      {
         ...
         while(_loc12_ < param2 + _loc8_)
         {
            ...
            _loc6_ -= _loc13_.preferred;
            _loc7_ -= _loc13_.min;
            _loc10_ += _loc13_.flex;
            _loc12_++;
         }
         if(_loc8_ > 1)
         {
         ...
         _loc6_ = _loc6_ > 0 ? Math.ceil(_loc6_ / _loc10_) : 0;
         _loc7_ = _loc7_ > 0 ? Math.ceil(_loc7_ / _loc10_) : 0;
         _loc12_ = param2;
         while(_loc12_ < param2 + _loc8_)
         {
            _loc13_ = param4[_loc12_];
            _loc15_ = _loc11_ ? 1 : _loc13_.flex;
            _loc13_.preferred += _loc6_ * _loc15_;
            _loc13_.min += _loc7_ * _loc15_;
            if(_loc9_)
            {
      ...
      private function distributeItemHeight(param1:GridItem, param2:Number, param3:Number, param4:Array) : void
      {
         ...
         _loc6_ = _loc6_ > 0 ? Math.ceil(_loc6_ / _loc9_) : 0;
         _loc7_ = _loc7_ > 0 ? Math.ceil(_loc7_ / _loc9_) : 0;
         _loc11_ = param2;
         while(_loc11_ < param2 + _loc8_)
         {
            _loc12_ = param4[_loc11_];
            _loc14_ = _loc10_ ? 1 : _loc12_.flex;
            _loc12_.preferred += _loc6_ * _loc14_;
            _loc12_.min += _loc7_ * _loc14_;
            _loc11_++;
         }
      ...
      override protected function measure() : void
      {
         ...
         {
            if((_loc4_ = GridRow(getChildAt(_loc10_))).includeInLayout)
            {
               _loc9_.push(_loc4_);
               _loc1_++;
            }
         ...
         while(_loc6_ < _loc1_)
         {
            ...
            while(_loc7_ < _loc4_.numGridItems)
            {
               ...
               (_loc5_ = GridItem(_loc4_.getChildAt(_loc7_))).colIndex = _loc8_;
               if(_loc5_.rowSpan > 1)
               {
         ...
         do
         {
            ...
            while(_loc6_ < _loc1_)
            {
               (_loc4_ = _loc9_[_loc6_]).columnWidths = columnWidths;
               _loc4_.rowHeights = rowHeights;
               _loc7_ = 0;
               while(_loc7_ < _loc4_.numGridItems)
               {
                  _loc28_ = (_loc5_ = GridItem(_loc4_.getChildAt(_loc7_))).rowSpan;
         ...
         while(_loc6_ < _loc1_)
         {
            if((_loc30_ = rowHeights[_loc6_]).min > _loc30_.preferred)
            {
            ...
            _loc17_ += _loc30_.min;
            _loc19_ += _loc30_.preferred;
            _loc6_++;
         }
         _loc6_ = 0;
         while(_loc6_ < _loc2_)
         {
            if((_loc31_ = columnWidths[_loc6_]).min > _loc31_.preferred)
            {
            ...
            _loc16_ += _loc31_.min;
            _loc18_ += _loc31_.preferred;
            _loc6_++;
         }
         var _loc20_:EdgeMetrics;
         var _loc21_:Number = (_loc20_ = viewMetricsAndPadding).left + _loc20_.right;
         var _loc24_:Number = 0;
         if(_loc2_ > 1)
         {
            _loc21_ += getStyle("horizontalGap") * (_loc2_ - 1);
         }
         _loc6_ = 0;
         while(_loc6_ < _loc1_)
         {
            if((_loc32_ = (_loc23_ = (_loc22_ = _loc9_[_loc6_]).viewMetricsAndPadding).left + _loc23_.right) > _loc24_)
            {
               _loc24_ = _loc32_;
            }
            _loc6_++;
         ...
         if(_loc1_ > 1)
         {
            _loc21_ += getStyle("verticalGap") * (_loc1_ - 1);
         }
         _loc6_ = 0;
         while(_loc6_ < _loc1_)
         {
            _loc23_ = (_loc22_ = _loc9_[_loc6_]).viewMetricsAndPadding;
            _loc21_ += _loc23_.top + _loc23_.bottom;
            _loc6_++;
         }
         _loc17_ += _loc21_;
         _loc19_ += _loc21_;
         ...
         while(_loc6_ < _loc1_)
         {
            (_loc22_ = _loc9_[_loc6_]).updateRowMeasurements();
            _loc6_++;
         }
         super.measure();
