package mx.controls
{
   ...
   public class TextArea extends ScrollControlBase implements IDataRenderer, IDropInListItemRenderer, IFocusManagerComponent, IIMESupport, IListItemRenderer, IFontContextComponent
   {
      ...
      {
         return height <= 40 ? ScrollPolicy.OFF : String(mx_internal::_horizontalScrollPolicy);
      }
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         var _loc6_:Number;
         if((_loc6_ = Math.min(textField.maxScrollH,_hScrollPosition)) != textField.scrollH)
         {
            horizontalScrollPosition = _loc6_;
         }
         if((_loc6_ = Math.min(textField.maxScrollV - 1,_vScrollPosition)) != textField.scrollV - 1)
         {
      ...
      {
         return height <= 40 ? ScrollPolicy.OFF : String(mx_internal::_verticalScrollPolicy);
      }
