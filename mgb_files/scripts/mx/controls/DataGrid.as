   ...
   public class DataGrid extends DataGridBase implements IIMESupport
   {
      ...
      override protected function mouseUpHandler(param1:MouseEvent) : void
      {
         ...
         if(_loc3_ && _loc3_ != itemEditorInstance && (lastItemDown == _loc3_ || itemRendererContains(lastItemDown,lastItemFocused)))
         {
            ...
            if((_loc7_ = itemRendererToIndices(_loc3_)) && _loc7_.y >= 0 && editable && !dontEdit)
            {
         ...
         else if(Boolean(lastItemDown) && lastItemDown != itemEditorInstance)
         {
            if((_loc7_ = itemRendererToIndices(lastItemDown)) && _loc7_.y >= 0 && editable && !dontEdit)
            {
               if(displayableColumns[_loc7_.x].editable)
               {
      ...
      private function itemEditorItemEditEndHandler(param1:DataGridEvent) : void
      {
         ...
         if(!param1.isDefaultPrevented())
         {
            ...
            if(Boolean(itemEditorInstance) && param1.reason != DataGridEventReason.CANCELLED)
            {
               ...
               _loc4_ = String(_columns[param1.columnIndex].dataField);
               ...
               {
                  (_loc8_ = DataGridListData(IDropInListItemRenderer(param1.itemRenderer).listData)).label = _columns[param1.columnIndex].itemToLabel(_loc5_);
      ...
      mx_internal function measureHeightOfItemsUptoMaxHeight(param1:int = -1, param2:int = 0, param3:Number = -1) : Number
      {
         ...
         {
            h = mx_internal::calculateHeaderHeight();
         ...
         for(; i < count; i++)
         {
            if(bMore)
            {
               ...
               while(j < n)
               {
                  ...
                  if(c.visible)
                  {
                     ...
                     mx_internal::setupRendererFromData(c,item,data);
            ...
            if(maxHeight != -1 && (h + ch > maxHeight || !bMore))
            {
               ...
               count = !!mx_internal::headerVisible ? i + 1 : i;
               setRowCount(count);
               return h;
            }
            h += ch;
      ...
      private function updateSortIndexAndDirection() : void
      {
         if(!sortableColumns)
         {
            mx_internal::lastSortIndex = mx_internal::sortIndex;
            mx_internal::sortIndex = -1;
            if(mx_internal::lastSortIndex != mx_internal::sortIndex)
            {
         ...
         if(!_loc2_)
         {
            mx_internal::sortIndex = mx_internal::lastSortIndex = -1;
            return;
         }
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            {
               mx_internal::sortIndex = !!_columns[_loc6_].sortable ? _loc6_ : -1;
               mx_internal::sortDirection = _loc4_.descending ? "DESC" : "ASC";
               return;
            }
            _loc6_++;
         }
      ...
      private function drawVerticalSeparator(param1:Sprite, param2:int, param3:uint, param4:Number, param5:Boolean = false) : void
      {
         ...
         if(_loc12_ = param5 ? _loc10_ : _loc11_)
         {
            param1.removeChild(DisplayObject(_loc12_));
         }
         if(!_loc13_)
         {
            if(_loc14_ = Class(getStyle(_loc9_)))
            {
               (_loc13_ = IFlexDisplayObject(new _loc14_())).name = _loc8_;
               if(_loc15_ = _loc13_ as ISimpleStyleClient)
               {
         ...
         if(_loc13_)
         {
            _loc16_ = !isNaN(_loc13_.measuredWidth) ? Number(_loc13_.measuredWidth) : 1;
      ...
      override mx_internal function resizeColumn(param1:int, param2:Number) : void
      {
         ...
         {
            param2 = Number(_columns[param1].minWidth);
         }
         ...
         else
         {
            ...
            while(_loc4_ < _loc3_)
            {
               if(_columns[_loc4_].visible)
               {
                  if(_columns[_loc4_].resizable)
                  {
                     if((_loc7_ = Math.floor(_columns[_loc4_].width * _loc8_ / _loc5_)) < _columns[_loc4_].minWidth)
                     {
                        _loc7_ = Number(_columns[_loc4_].minWidth);
                     }
                     _columns[_loc4_].setWidth(_loc7_);
                     _loc9_ += _columns[_loc4_].width;
            ...
            if(_loc9_ > _loc8_)
            {
               if((_loc7_ = _columns[param1].width - _loc9_ + _loc8_) < _columns[param1].minWidth)
               {
                  _loc7_ = Number(_columns[param1].minWidth);
               }
      ...
      override public function showDropFeedback(param1:DragEvent) : void
      {
         ...
         {
            if(!mx_internal::lockedColumnDropIndicator)
            {
               ...
               mx_internal::lockedColumnDropIndicator = IFlexDisplayObject(new _loc2_());
               mx_internal::lockedColumnDropIndicator.x = 2;
               mx_internal::lockedColumnDropIndicator.setActualSize(lockedColumnContent.width - 2,4);
               mx_internal::lockedColumnDropIndicator.visible = true;
            }
            if(mx_internal::dropIndicator.parent == listContent)
            {
               lockedColumnContent.addChild(DisplayObject(mx_internal::lockedColumnDropIndicator));
            }
            else
            {
               lockedColumnAndRowContent.addChild(DisplayObject(mx_internal::lockedColumnDropIndicator));
            }
            mx_internal::lockedColumnDropIndicator.y = mx_internal::dropIndicator.y;
         }
      }
      ...
      protected function setNewValue(param1:Object, param2:String, param3:Object, param4:int) : Boolean
      {
         ...
         {
            _loc6_ = (_loc5_ = param2.split(".")).pop();
            (_loc7_ = deriveComplexFieldReference(param1,_loc5_))[_loc6_] = param3;
         }
         return true;
      }
      ...
      private function itemEditorItemEditBeginHandler(param1:DataGridEvent) : void
      {
         ...
         if(!param1.isDefaultPrevented() && actualContentHolder.listItems[actualRowIndex][actualColIndex].data != null)
         {
            ...
            {
               IIMESupport(itemEditorInstance).imeMode = columns[param1.columnIndex].imeMode == null ? _imeMode : String(columns[param1.columnIndex].imeMode);
            }
            _loc2_ = focusManager;
            if(itemEditorInstance is IFocusManagerComponent)
            {
      ...
      {
         return mx_internal::measureHeightOfItemsUptoMaxHeight(param1,param2);
      }
      ...
      override protected function makeRowsAndColumns(param1:Number, param2:Number, param3:Number, param4:Number, param5:int, param6:int, param7:Boolean = false, param8:uint = 0) : Point
      {
         ...
         if(itemEditorInstance)
         {
            ...
            if(Boolean(lockedColumnCount) && editedItemPosition.columnIndex <= mx_internal::visibleLockedColumns[lockedColumnCount - 1].colNum)
            {
               _loc10_ = mx_internal::visibleLockedColumns[actualColIndex];
            }
            else
            {
               _loc10_ = mx_internal::visibleColumns[actualColIndex];
            }
            ...
            if(_loc13_ = Sprite(actualContentHolder.getChildByName("lines")))
            {
      ...
      private function scrollToEditedItem(param1:int, param2:int) : void
      {
         ...
         var _loc6_:uint = Boolean(_loc3_) && Boolean(_loc3_[0]) ? uint(_loc3_[0].length) : uint(mx_internal::visibleColumns.length);
         ...
         if(param2 > lockedColumnCount)
         {
            ...
            else
            {
               while(param2 > _loc7_ || param2 == _loc7_ && param2 > horizontalScrollPosition + lockedColumnCount && _loc8_)
               {
                  ...
                  _loc6_ = Boolean(_loc3_) && Boolean(_loc3_[0]) ? uint(_loc3_[0].length) : uint(mx_internal::visibleColumns.length);
      ...
      private function sortByColumn(param1:int) : void
      {
         ...
         var _loc3_:* = _loc2_.sortDescending;
         if(_loc2_.sortable)
         {
            if(_loc4_ = collection.sort)
            {
               _loc4_.compareFunction = null;
               if(_loc7_ = _loc4_.fields)
               {
                  _loc8_ = 0;
                  while(_loc8_ < _loc7_.length)
                  {
                     ...
                     {
                        _loc3_ = !(_loc5_ = _loc7_[_loc8_]).descending;
                        break;
                     }
                     _loc8_++;
                  }
            ...
            mx_internal::sortDirection = _loc6_;
            mx_internal::lastSortIndex = mx_internal::sortIndex;
            mx_internal::sortIndex = param1;
            sortColumn = _loc2_;
      ...
      override mx_internal function columnRendererChanged(param1:DataGridColumn) : void
      {
         ...
         if(_loc3_)
         {
            ...
            if(_loc5_ = freeItemRenderersTable[param1] as Array)
            {
               while(_loc5_.length)
               {
                  _loc2_ = _loc5_.pop();
      ...
      override protected function measure() : void
      {
         ...
         _loc1_ = viewMetrics;
         var _loc2_:int = int(columns.length);
         if(_loc2_ == 0)
         {
         ...
         while(_loc5_ < _loc2_)
         {
            if(columns[_loc5_].visible)
            {
               _loc3_ += columns[_loc5_].preferredWidth;
               if(isNaN(_minColumnWidth))
               {
                  _loc4_ += columns[_loc5_].minWidth;
               }
            }
            _loc5_++;
         }
      ...
      override protected function focusInHandler(param1:FocusEvent) : void
      {
         ...
         if(param1.target != this)
         {
            if(Boolean(itemEditorInstance) && itemRendererContains(itemEditorInstance,DisplayObject(param1.target)))
            {
               return;
            }
         ...
         if(editable && !mx_internal::isPressed)
         {
            ...
            {
               if(Boolean(_columns[_editedItemPosition.columnIndex].editable) && Boolean(_columns[_editedItemPosition.columnIndex].visible))
               {
                  _loc3_ = true;
                  break;
               }
      ...
      {
         drawLinesAndColumnGraphics(listContent,mx_internal::visibleColumns,{});
      }
      ...
      override protected function collectionChangeHandler(param1:Event) : void
      {
         ...
         if(param1 is CollectionEvent)
         {
            ...
            else if(_loc3_.kind == CollectionEventKind.REMOVE)
            {
               if(editedItemPosition)
               {
                  ...
                  {
                     _loc2_ = editedItemPosition;
                     if(_loc3_.location == editedItemPosition.rowIndex && Boolean(itemEditorInstance))
                     {
                        endEdit(DataGridEventReason.CANCELLED);
                     }
                     if(inEndEdit)
         ...
         if(param1 is CollectionEvent)
         {
            if((_loc4_ = CollectionEvent(param1)).kind == CollectionEventKind.ADD)
            {
      ...
      override protected function scrollVertically(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         if(getStyle("horizontalGridLines"))
         {
            ...
            if(lockedColumnCount)
            {
               drawLinesAndColumnGraphics(lockedColumnContent,mx_internal::visibleLockedColumns,{"right":1});
            }
         }
      }
      ...
      override public function get baselinePosition() : Number
      {
         ...
         if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_3_0)
         {
            ...
            {
               _loc2_ = Number(IRectangularBorder(border).borderMetrics.top);
            }
      ...
      mx_internal function calculateHeaderHeight() : Number
      {
         ...
         {
            _loc4_ = 0;
            _loc5_ = int(columns.length);
            if(_headerWordWrapPresent)
            {
               mx_internal::_headerHeight = _originalHeaderHeight;
               mx_internal::_explicitHeaderHeight = _originalExplicitHeaderHeight;
            }
            _loc6_ = 0;
            while(_loc6_ < _loc5_)
            {
            ...
            if(_headerWordWrapPresent)
            {
               _originalHeaderHeight = mx_internal::_headerHeight;
               _originalExplicitHeaderHeight = mx_internal::_explicitHeaderHeight;
      ...
      private function calculateColumnSizes() : void
      {
         ...
         if(mx_internal::columnsInvalid)
         {
            ...
            else
            {
               ...
               while(_loc3_ < _loc2_)
               {
                  ...
                  {
                     if((_loc5_ = displayableColumns[_loc3_]).mx_internal::preferredWidth < _loc5_.minWidth)
                     {
                     ...
                     if(_loc4_ >= displayWidth)
                     {
                        ...
                        {
                           mx_internal::visibleColumns.push(displayableColumns[0]);
                        }
                        break;
                     }
                     if(_loc3_ < lockedColumnCount)
                     {
                        lockedColumnWidth += Math.max(isNaN(_loc5_.mx_internal::explicitWidth) ? _loc5_.mx_internal::preferredWidth : _loc5_.mx_internal::explicitWidth,_loc5_.minWidth);
                        mx_internal::visibleLockedColumns.push(_loc5_);
                     }
                     else
                     {
         ...
         if(horizontalScrollPolicy == ScrollPolicy.OFF)
         {
            ...
            if(displayWidth > _loc11_ && Boolean(_loc10_))
            {
               _loc2_ = int(mx_internal::visibleLockedColumns.length);
               _loc3_ = 0;
               while(_loc3_ < _loc2_)
               {
                  if(mx_internal::visibleLockedColumns[_loc3_].resizable && !mx_internal::visibleLockedColumns[_loc3_].newlyVisible && isNaN(mx_internal::visibleLockedColumns[_loc3_].explicitWidth))
                  {
               ...
               while(_loc3_ < _loc2_)
               {
                  if(mx_internal::visibleColumns[_loc3_].resizable && !mx_internal::visibleColumns[_loc3_].newlyVisible && isNaN(mx_internal::visibleColumns[_loc3_].explicitWidth))
                  {
            ...
            else
            {
               ...
               while(_loc3_ < _loc2_)
               {
                  _loc12_ = (_loc7_ = mx_internal::visibleLockedColumns[_loc3_]).width / _loc4_;
               ...
               while(_loc3_ < _loc2_)
               {
                  _loc12_ = (_loc7_ = mx_internal::visibleColumns[_loc3_]).width / _loc4_;
                  _loc8_ = displayWidth * _loc12_;
                  _loc7_.mx_internal::setWidth(_loc8_);
                  _loc7_.mx_internal::explicitWidth = NaN;
                  _loc13_ -= _loc8_;
         ...
         else
         {
            ...
            else if(_loc4_ < displayWidth - lockedColumnWidth && horizontalScrollPosition > 0)
            {
               while(_loc4_ < displayWidth - lockedColumnWidth && horizontalScrollPosition > 0)
               {
                  ...
                  if((_loc6_ = isNaN(_loc5_.mx_internal::explicitWidth) ? _loc5_.mx_internal::preferredWidth : _loc5_.mx_internal::explicitWidth) >= displayWidth - lockedColumnWidth - _loc4_)
                  {
                     break;
                  }
                  mx_internal::visibleColumns.splice(0,0,_loc5_);
                  var _loc15_:*;
                  var _loc16_:* = _loc15_ = this.super.horizontalScrollPosition - 1;
                  _loc15_.super.horizontalScrollPosition = _loc16_;
                  _loc4_ += _loc6_;
               }
            }
            _loc7_ = mx_internal::visibleColumns[mx_internal::visibleColumns.length - 1];
            _loc8_ = (_loc6_ = isNaN(_loc7_.mx_internal::explicitWidth) ? _loc7_.mx_internal::preferredWidth : _loc7_.mx_internal::explicitWidth) + displayWidth - lockedColumnWidth - _loc4_;
            if(_loc7_ == displayableColumns[displayableColumns.length - 1] && _loc7_.resizable && _loc8_ >= _loc7_.minWidth && _loc8_ > _loc6_)
            {
               _loc7_.mx_internal::setWidth(_loc8_);
               maxHorizontalScrollPosition = displayableColumns.length - mx_internal::visibleColumns.length;
            }
            else if(mx_internal::visibleColumns.length == 1 && _loc7_ == displayableColumns[displayableColumns.length - 1])
            {
               maxHorizontalScrollPosition = displayableColumns.length - mx_internal::visibleColumns.length;
            }
            else
            {
               maxHorizontalScrollPosition = displayableColumns.length - mx_internal::visibleColumns.length + 1;
            }
         }
         lockedColumnWidth = 0;
         if(mx_internal::visibleLockedColumns.length)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               ...
               lockedColumnWidth += _loc5_.width;
               _loc3_++;
            }
         }
      }
      ...
      {
         var _loc4_:DataGridEvent;
         (_loc4_ = new DataGridEvent(DataGridEvent.ITEM_EDIT_BEGINNING,false,true)).columnIndex = param1;
      ...
      protected function drawRowGraphics(param1:ListBaseContentHolder) : void
      {
         ...
         _loc7_ = int(param1.listItems.length);
         while(_loc4_ < _loc7_)
         {
      ...
      protected function drawHorizontalLine(param1:Sprite, param2:int, param3:uint, param4:Number) : void
      {
         ...
         var _loc6_:Graphics;
         (_loc6_ = param1.graphics).lineStyle(1,param3);
      ...
      {
         return displayableColumns[mx_internal::sortIndex == -1 ? 0 : mx_internal::sortIndex].itemToLabel(param1);
      }
      ...
      override protected function configureScrollBars() : void
      {
         ...
         if(mx_internal::visibleColumns && !mx_internal::visibleColumns.length && mx_internal::visibleLockedColumns && Boolean(mx_internal::visibleLockedColumns.length))
         {
         ...
         var _loc7_:Boolean;
         var _loc8_:int = (_loc7_ = Boolean(collection) && collection.length > 0) && _loc4_ > 0 ? int(listItems[0].length) : int(mx_internal::visibleColumns.length);
         if(_loc7_ && _loc4_ > 0 && _loc8_ > 1 && listItems[0][_loc8_ - 1].x + mx_internal::visibleColumns[_loc8_ - 1].width > displayWidth - listContent.x + viewMetrics.left)
         {
            _loc8_--;
         }
         else if(_loc8_ > 1 && !_loc7_)
         {
            _loc9_ = 0;
            _loc10_ = 0;
            while(_loc10_ < mx_internal::visibleColumns.length)
            {
               _loc9_ += mx_internal::visibleColumns[_loc10_].width;
               _loc10_++;
            }
         ...
         setScrollBarProperties(displayableColumns.length - lockedColumnCount,Math.max(_loc8_,1),!!collection ? collection.length - lockedRowCount : 0,Math.max(_loc4_,1));
      ...
      override public function set horizontalScrollPosition(param1:Number) : void
      {
         ...
         if(_loc2_ != param1)
         {
            ...
            if(Boolean(mx_internal::headerVisible) && Boolean(header))
            {
      ...
      protected function drawColumnBackground(param1:Sprite, param2:int, param3:uint, param4:DataGridColumn) : void
      {
         ...
         if(!(_loc5_ = Shape(param1.getChildByName(param2.toString()))))
         {
         ...
         var _loc6_:Graphics;
         (_loc6_ = _loc5_.graphics).clear();
         _loc6_.beginFill(param3);
         var _loc7_:Object = rowInfo[listItems.length - 1];
         var _loc8_:DataGridHeader;
         var _loc9_:Number = Number((_loc8_ = param1.parent == lockedColumnContent ? DataGridHeader(lockedColumnHeader) : DataGridHeader(header)).mx_internal::rendererArray[param2].x);
      ...
      override public function set columns(param1:Array) : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            mx_internal::columnRendererChanged(_columns[_loc3_]);
            _loc3_++;
         }
         ...
         while(_loc3_ < _loc2_)
         {
            (_loc4_ = _columns[_loc3_]).mx_internal::owner = this;
            _loc4_.mx_internal::colNum = _loc3_;
            if(_loc4_.mx_internal::cachedHeaderRenderer)
            {
               if((_loc5_ = _loc4_.mx_internal::cachedHeaderRenderer as DisplayObject).parent)
               {
      ...
      override protected function commitProperties() : void
      {
         ...
         if(itemsNeedMeasurement)
         {
            ...
            {
               if(Boolean(iterator) && columns.length > 0)
               {
                  mx_internal::visibleColumns = columns;
                  mx_internal::columnsInvalid = true;
                  ...
                  while(_loc8_ < _loc7_)
                  {
                     if((_loc5_ = columns[_loc8_]).visible)
                     {
                        _loc4_ = _loc5_.mx_internal::getMeasuringRenderer(false,_loc3_);
                        if(DisplayObject(_loc4_).parent == null)
                        {
                           listContent.addChild(DisplayObject(_loc4_));
                        }
                        mx_internal::setupRendererFromData(_loc5_,_loc4_,_loc3_);
      ...
      override protected function calculateRowHeight(param1:Object, param2:Number, param3:Boolean = false) : Number
      {
         ...
         var _loc5_:DataGridColumn = null;
         var _loc7_:int = 0;
         var _loc6_:int = int(columns.length);
         var _loc8_:int = 0;
         ...
         while(_loc7_ < _loc6_)
         {
            if(param3 && _loc8_ < _loc9_ && mx_internal::visibleLockedColumns[_loc8_].colNum == columns[_loc7_].colNum)
            {
               _loc8_++;
            }
            else if(param3 && _loc8_ - _loc9_ < mx_internal::visibleColumns.length && mx_internal::visibleColumns[_loc8_ - _loc9_].colNum == columns[_loc7_].colNum)
            {
               _loc8_++;
            }
            else if((_loc5_ = columns[_loc7_]).visible)
            {
               ...
               mx_internal::setupRendererFromData(_loc5_,_loc4_,param1);
      ...
      protected function drawLinesAndColumnGraphics(param1:ListBaseContentHolder, param2:Array, param3:Object) : void
      {
         ...
         var _loc4_:Sprite;
         if(!(_loc4_ = Sprite(param1.getChildByName("lines"))))
         {
            (_loc4_ = new UIComponent()).name = "lines";
         ...
         var _loc6_:Sprite;
         if(!(_loc6_ = Sprite(_loc4_.getChildByName("body"))))
         {
            (_loc6_ = new UIComponent()).name = "body";
         ...
         var _loc10_:uint = !!param2 ? param2.length : 0;
         ...
         if(getStyle("horizontalGridLines"))
         {
            ...
            {
               if((_loc13_ = _loc5_[_loc9_].y + _loc5_[_loc9_].height) < param1.height)
               {
         ...
         if(Boolean(param3.bottom) && _loc11_ > 0)
         {
         ...
         if(_loc10_)
         {
            ...
            while(_loc9_ < _loc10_)
            {
               ...
               if(_loc18_ !== null && !isNaN(Number(_loc18_)))
               {
                  if(!_loc14_)
                  {
                     (_loc14_ = new FlexSprite()).mouseEnabled = false;
                     _loc14_.name = "colBGs";
               ...
               {
                  if(_loc19_ = Shape(_loc14_.getChildByName(_loc9_.toString())))
                  {
                     (_loc20_ = _loc19_.graphics).clear();
                     _loc14_.removeChild(_loc19_);
                  }
               }
               _loc16_ += param2[_loc9_].width;
               _loc9_++;
            }
            if(Boolean(_loc14_) && Boolean(_loc14_.numChildren))
            {
         ...
         if(param3.right && param2 && Boolean(param2.length))
         {
      ...
      private function commitEditedItemPosition(param1:Object) : void
      {
         ...
         var _loc5_:IListItemRenderer;
         if(!(_loc5_ = actualContentHolder.listItems[actualRowIndex][actualColIndex]))
         {
         ...
         if(_loc4_)
         {
            (_loc9_ = new ListEvent(ListEvent.CHANGE)).columnIndex = param1.columnIndex;
            _loc9_.rowIndex = param1.rowIndex;
            _loc9_.itemRenderer = _loc5_;
            dispatchEvent(_loc9_);
         }
         var _loc6_:DataGridEvent;
         (_loc6_ = new DataGridEvent(DataGridEvent.ITEM_EDIT_BEGIN,false,true)).columnIndex = displayableColumns[_loc3_].colNum;
      ...
      protected function drawVerticalLine(param1:Sprite, param2:int, param3:uint, param4:Number) : void
      {
         var _loc5_:ListBaseContentHolder = param1.parent.parent as ListBaseContentHolder;
         var _loc6_:Graphics;
         (_loc6_ = param1.graphics).lineStyle(1,param3,100);
         _loc6_.moveTo(param4,!!mx_internal::headerVisible ? 0 : 1);
      ...
      override protected function adjustListContent(param1:Number = -1, param2:Number = -1) : void
      {
         ...
         if(mx_internal::headerVisible)
         {
            ...
            if(verticalScrollBar != null && verticalScrollBar.visible && (horizontalScrollBar == null || !horizontalScrollBar.visible) && Boolean(mx_internal::headerVisible) && roomForScrollBar(verticalScrollBar,unscaledWidth,unscaledHeight - header.height))
            {
         ...
         if(lockedRowCount > 0 && lockedRowContent && Boolean(lockedRowContent.iterator))
         {
            try
            {
               lockedRowContent.iterator.seek(CursorBookmark.FIRST);
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(verticalScrollBar != null && verticalScrollBar.visible && (horizontalScrollBar == null || !horizontalScrollBar.visible) && Boolean(mx_internal::headerVisible))
         {
         ...
         if(Boolean(lockedRowCount) && Boolean(lockedRowContent))
         {
            ...
            drawLinesAndColumnGraphics(lockedRowContent,mx_internal::visibleColumns,{"bottom":1});
            if(lockedColumnCount)
            {
               drawRowGraphics(lockedColumnAndRowContent);
               drawLinesAndColumnGraphics(lockedColumnAndRowContent,mx_internal::visibleLockedColumns,{
                  "right":1,
                  "bottom":1
               });
            }
      ...
      mx_internal function shiftColumns(param1:int, param2:int, param3:Event = null) : void
      {
         ...
         if(param2 >= 0 && param1 != param2)
         {
            ...
            if(mx_internal::sortIndex == param1)
            {
               mx_internal::sortIndex += param2 - param1;
            }
            else if(param1 < mx_internal::sortIndex && mx_internal::sortIndex <= param2 || param2 <= mx_internal::sortIndex && mx_internal::sortIndex < param1)
            {
               mx_internal::sortIndex -= _loc4_;
            }
            if(mx_internal::lastSortIndex == param1)
            {
               mx_internal::lastSortIndex += param2 - param1;
            }
            else if(param1 < mx_internal::lastSortIndex && mx_internal::lastSortIndex <= param2 || param2 <= mx_internal::lastSortIndex && mx_internal::lastSortIndex < param1)
            {
               mx_internal::lastSortIndex -= _loc4_;
            }
            mx_internal::columnsInvalid = true;
            itemsSizeChanged = true;
            invalidateDisplayList();
            ...
            (_loc6_ = new IndexChangedEvent(IndexChangedEvent.HEADER_SHIFT)).oldIndex = param1;
      ...
      override public function hideDropFeedback(param1:DragEvent) : void
      {
         ...
         if(mx_internal::lockedColumnDropIndicator)
         {
            DisplayObject(mx_internal::lockedColumnDropIndicator).parent.removeChild(DisplayObject(mx_internal::lockedColumnDropIndicator));
            mx_internal::lockedColumnDropIndicator = null;
         }
      }
