package mx.controls
{
   ...
   public class NavBar extends Box
   {
      ...
      {
         mx_internal::navItemFactory = new ClassFactory(Button);
         super();
      ...
      override public function set enabled(param1:Boolean) : void
      {
         ...
         if(param1 != enabled)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               if(mx_internal::targetStack)
               {
                  Button(getChildAt(_loc3_)).enabled = param1 && Container(mx_internal::targetStack.getChildAt(_loc3_)).enabled;
               }
               else
               {
      ...
      {
         var _loc2_:int = mx_internal::targetStack.getChildIndex(DisplayObject(param1.target));
         Button(getChildAt(_loc2_)).enabled = enabled && Boolean(param1.target.enabled);
      }
      ...
      protected function clickHandler(param1:MouseEvent) : void
      {
         ...
         if(mx_internal::targetStack)
         {
            mx_internal::targetStack.selectedIndex = _loc2_;
         }
      ...
      private function childAddHandler(param1:ChildExistenceChangedEvent) : void
      {
         ...
         if(param1.relatedObject.parent != mx_internal::targetStack)
         {
            return;
         }
      ...
      private function createNavChildren() : void
      {
         ...
         i = 0;
         for(; i < n; navItem.enabled = enabled,i++)
         {
            ...
            else
            {
               ...
               if(toolTipField)
               {
                  try
                  {
                     navItem.toolTip = item[toolTipField] === undefined ? null : String(item[toolTipField]);
                  }
                  catch(e:Error)
                  {
                  }
      ...
      private function _setTargetViewStack(param1:Object) : void
      {
         ...
         if(mx_internal::targetStack)
         {
            mx_internal::targetStack.removeEventListener(ChildExistenceChangedEvent.CHILD_ADD,childAddHandler);
            mx_internal::targetStack.removeEventListener(ChildExistenceChangedEvent.CHILD_REMOVE,childRemoveHandler);
            mx_internal::targetStack.removeEventListener(Event.CHANGE,changeHandler);
            mx_internal::targetStack.removeEventListener(IndexChangedEvent.CHILD_INDEX_CHANGE,childIndexChangeHandler);
            _loc4_ = mx_internal::targetStack.numChildren;
            _loc6_ = 0;
            while(_loc6_ < _loc4_)
            {
               (_loc5_ = Container(mx_internal::targetStack.getChildAt(_loc6_))).removeEventListener("labelChanged",labelChangedHandler);
         ...
         removeAllChildren();
         _selectedIndex = -1;
         mx_internal::targetStack = _loc2_;
         if(!mx_internal::targetStack)
         {
            return;
         }
         mx_internal::targetStack.addEventListener(ChildExistenceChangedEvent.CHILD_ADD,childAddHandler);
         mx_internal::targetStack.addEventListener(ChildExistenceChangedEvent.CHILD_REMOVE,childRemoveHandler);
         mx_internal::targetStack.addEventListener(Event.CHANGE,changeHandler);
         mx_internal::targetStack.addEventListener(IndexChangedEvent.CHILD_INDEX_CHANGE,childIndexChangeHandler);
         _loc4_ = mx_internal::targetStack.numChildren;
         _loc6_ = 0;
         while(_loc6_ < _loc4_)
         {
            _loc5_ = Container(mx_internal::targetStack.getChildAt(_loc6_));
         ...
         var _loc3_:int = mx_internal::targetStack.selectedIndex;
         if(_loc3_ == -1 && mx_internal::targetStack.numChildren > 0)
         {
            _loc3_ = 0;
         }
         if(_loc3_ != -1)
      ...
      {
         return !!mx_internal::targetStack ? mx_internal::targetStack : _dataProvider;
      }
      ...
      override protected function commitProperties() : void
      {
         ...
         {
            mx_internal::blocker.visible = false;
         }
      }
      ...
      public function set dataProvider(param1:Object) : void
      {
         ...
         {
            _loc2_ = String(resourceManager.getString("controls","errWrongContainer",[id]));
         ...
         if(param1 is IList && IList(param1).length > 0 && IList(param1).getItemAt(0) is DisplayObject || param1 is Array && (param1 as Array).length > 0 && param1[0] is DisplayObject)
         {
            ...
            _loc2_ = String(resourceManager.getString("controls","errWrongType",[_loc3_]));
            throw new Error(_loc2_);
         }
      ...
      public function set selectedIndex(param1:int) : void
      {
         ...
         if(mx_internal::targetStack)
         {
            mx_internal::targetStack.selectedIndex = param1;
         }
