package mx.controls.listClasses
{
   ...
   public class TileBase extends ListBase
   {
      ...
      override public function measureWidthOfItems(param1:int = -1, param2:int = 0) : Number
      {
         ...
         {
            _loc8_ = (_loc7_ = iterator.current) is ItemWrapper ? _loc7_.data : _loc7_;
            if(!measuringObjects)
            {
            ...
            if(!_loc3_)
            {
               _loc3_ = mx_internal::getMeasuringRenderer(_loc8_);
               _loc6_ = true;
            }
            ...
            _loc4_ = Number(_loc3_.getExplicitOrMeasuredWidth());
            if(_loc6_)
            {
      ...
      override mx_internal function reconstructDataFromListItems() : Array
      {
         ...
         if(listItems.length > 0)
         {
            ...
            while(_loc2_ < listItems[0].length)
            {
               ...
               {
                  if(Boolean(listItems[_loc3_]) && listItems[_loc3_].length > _loc2_)
                  {
                     if(_loc4_ = listItems[_loc3_][_loc2_] as IListItemRenderer)
                     {
                        _loc5_ = _loc4_.data;
                        _loc1_.push(_loc5_);
                     }
      ...
      override protected function moveSelectionHorizontally(param1:uint, param2:Boolean, param3:Boolean) : void
      {
         ...
         var _loc13_:int = maxColumns > 0 && direction != TileBaseDirection.VERTICAL ? maxColumns : _loc12_;
         ...
         switch(param1)
         {
            case Keyboard.LEFT:
               if(caretIndex > 0)
               {
                  ...
                  else
                  {
                     ...
                     if((_loc11_ = indexToColumn(caretIndex)) == 0)
                     {
                        _loc10_--;
            ...
            case Keyboard.RIGHT:
               if(caretIndex < collection.length - 1)
               {
                  ...
                  {
                     _loc10_ = indexToRow(caretIndex);
                     if((_loc11_ = indexToColumn(caretIndex)) == lastColumnInRow(_loc10_))
                     {
                        _loc11_ = 0;
                        _loc10_++;
                     }
            ...
            case Keyboard.PAGE_UP:
               ...
               if((_loc11_ = indexToColumn(caretIndex)) > 0)
               {
                  caretIndex = indicesToIndex(_loc10_,_loc5_ = int(Math.max(horizontalScrollPosition - (_loc12_ - _loc15_),0)));
               }
               break;
            case Keyboard.PAGE_DOWN:
               ...
               _loc10_ = indexToRow(caretIndex);
               if((_loc11_ = indexToColumn(caretIndex)) < maxHorizontalScrollPosition)
               {
                  if((_loc11_ = Math.min(horizontalScrollPosition + _loc12_ - _loc15_,indexToColumn(collection.length - 1))) > horizontalScrollPosition)
                  {
         ...
         if(!isNaN(_loc4_))
         {
            ...
            {
               (_loc16_ = new ScrollEvent(ScrollEvent.SCROLL)).detail = ScrollEventDetail.THUMB_POSITION;
      ...
      override protected function commitProperties() : void
      {
         ...
         if(itemsNeedMeasurement)
         {
            ...
            {
               mx_internal::setColumnWidth(measureWidthOfItems(0,1));
            }
         }
      }
      ...
      override public function createItemRenderer(param1:Object) : IListItemRenderer
      {
         ...
         {
            if(freeItemRenderers && freeItemRenderers.length && Boolean(freeItemRenderersByFactory[_loc2_]))
            {
      ...
      protected function drawTileBackgrounds() : void
      {
         ...
         while(_loc4_ < rowCount)
         {
            ...
            {
               _loc7_ = _loc4_ < rowCount - 1 ? rowHeight : Math.min(rowHeight,listContent.height - (rowCount - 1) * rowHeight);
               _loc8_ = _loc6_ < columnCount - 1 ? columnWidth : Math.min(columnWidth,listContent.width - (columnCount - 1) * columnWidth);
               ...
               (_loc11_ = drawTileBackground(_loc1_,_loc4_,_loc6_,_loc8_,_loc7_,_loc2_[_loc10_ % _loc2_.length],_loc9_)).y = _loc4_ * rowHeight;
      ...
      override protected function finishKeySelection() : void
      {
         ...
         if(_loc2_)
         {
            (_loc6_ = new ListEvent(ListEvent.CHANGE)).itemRenderer = _loc5_;
      ...
      override protected function indexToColumn(param1:int) : int
      {
         ...
         if(direction == TileBaseDirection.VERTICAL)
         {
            _loc3_ = maxRows > 0 ? maxRows : rowCount;
            return Math.floor(param1 / _loc3_);
         }
         var _loc2_:int = maxColumns > 0 ? maxColumns : columnCount;
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         {
            mx_internal::setColumnWidth(Math.floor((width - viewMetrics.left - viewMetrics.right) / explicitColumnCount));
         }
      ...
      override protected function scrollHorizontally(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         if(param3)
         {
            ...
            _loc15_ = _loc14_ = param2 - (offscreenExtraColumnsLeft - _loc11_);
         }
         else
         {
            _loc20_ = offscreenExtraColumnsRight == 0 && listItems[0] && listItems[0].length > 0 && Boolean(listItems[0][listItems[0].length - 1]) && listItems[0][listItems[0].length - 1].x + columnWidth < listContent.widthExcludingOffsets - listContent.leftOffset ? 1 : 0;
         ...
         var _loc17_:int = int(listItems[0].length);
         var _loc18_:int = 0;
         while(_loc18_ < _loc15_)
         {
            ...
            {
               if(_loc22_ = param3 ? listItems[_loc21_][_loc18_] : listItems[_loc21_][_loc17_ - _loc18_ - 1])
               {
         ...
         if(param3)
         {
            ...
            while(_loc18_ < _loc17_)
            {
               ...
               while(_loc21_ < rowCount)
               {
                  if(_loc27_ = listItems[_loc21_][_loc18_])
                  {
                     _loc22_ = _loc27_;
                     _loc22_.x -= _loc9_;
                     _loc7_ = String(rowMap[_loc22_.name].uid);
                     listItems[_loc21_][_loc18_ - _loc14_] = _loc22_;
                     rowMap[_loc22_.name].columnIndex -= _loc14_;
            ...
            if(_loc26_ = listItems[0].length - (_loc24_ + _loc25_.x))
            {
               _loc18_ = 0;
         ...
         else
         {
            ...
            _loc18_ = (_loc28_ = _loc17_ + _loc16_) - _loc14_ - 1;
            while(_loc18_ >= 0)
            {
               _loc21_ = 0;
               while(_loc21_ < rowCount)
               {
                  if(_loc22_ = listItems[_loc21_][_loc18_])
                  {
                     _loc22_.x += _loc9_;
                     _loc7_ = String(rowMap[_loc22_.name].uid);
                     listItems[_loc21_][_loc18_ + _loc14_] = _loc22_;
         ...
         listContent.rightOffset = !!offscreenExtraColumnsRight ? listItems[0][listItems[0].length - 1].x + listItems[0][listItems[0].length - 1].width + listContent.leftOffset - _loc19_ : 0;
         adjustListContent();
      ...
      override protected function moveSelectionVertically(param1:uint, param2:Boolean, param3:Boolean) : void
      {
         ...
         var _loc14_:int = maxRows > 0 && direction != TileBaseDirection.HORIZONTAL ? maxRows : _loc13_;
         ...
         switch(param1)
         {
            ...
            case Keyboard.PAGE_DOWN:
               ...
               if(_loc11_ < maxVerticalScrollPosition)
               {
                  ...
                  else if((_loc11_ = Math.min(verticalScrollPosition + _loc13_ - _loc15_,indexToRow(collection.length - 1))) == verticalScrollPosition + _loc13_ - _loc15_)
                  {
                     _loc4_ = Math.min(verticalScrollPosition + _loc13_ - _loc15_,maxVerticalScrollPosition);
                  }
                  caretIndex = Math.min(indicesToIndex(_loc11_,_loc12_),collection.length - 1);
         ...
         if(!isNaN(_loc4_))
         {
            if(_loc4_ != verticalScrollPosition)
            {
               (_loc17_ = new ScrollEvent(ScrollEvent.SCROLL)).detail = ScrollEventDetail.THUMB_POSITION;
      ...
      override protected function scrollVertically(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         if(param3)
         {
            ...
            _loc15_ = _loc14_ = param2 - (offscreenExtraRowsTop - _loc11_);
         }
         else
         {
            _loc21_ = offscreenExtraRowsBottom == 0 && listItems.length && Boolean(listItems[listItems.length - 1][0]) && listItems[listItems.length - 1][0].y + rowHeight < listContent.heightExcludingOffsets - listContent.topOffset ? 1 : 0;
         ...
         while(_loc18_ < _loc15_)
         {
            ...
            {
               if(_loc23_ = param3 ? listItems[_loc18_][_loc22_] : listItems[_loc17_ - _loc18_ - 1][_loc22_])
               {
         ...
         var _loc19_:int = int(listItems.length);
         if(param3)
         {
            ...
            {
               _loc5_ = int(listItems[_loc18_].length);
               _loc22_ = 0;
               while(_loc22_ < columnCount && _loc22_ < _loc5_)
               {
                  ...
                  {
                     _loc23_.y -= _loc9_;
                     rowMap[_loc23_.name].rowIndex -= _loc14_;
               ...
               rowInfo[_loc18_ - _loc14_].y -= _loc9_;
         ...
         else
         {
            ...
            _loc9_ = _loc14_ * rowHeight;
            _loc6_ = Number(rowInfo[_loc14_].y);
            ...
            while(_loc18_ >= 0)
            {
               ...
               while(_loc22_ < columnCount && _loc22_ < _loc5_)
               {
                  if(_loc23_ = listItems[_loc18_][_loc22_])
                  {
                     _loc23_.y += _loc9_;
                     rowMap[_loc23_.name].rowIndex += _loc14_;
                     _loc7_ = String(rowMap[_loc23_.name].uid);
                     listItems[_loc18_ + _loc14_][_loc22_] = _loc23_;
         ...
         listContent.bottomOffset = !!offscreenExtraRowsBottom ? rowInfo[rowInfo.length - 1].y + rowHeight + listContent.topOffset - _loc20_ : 0;
         adjustListContent();
         mx_internal::addClipMask(false);
      }
      ...
      override public function showDropFeedback(param1:DragEvent) : void
      {
         ...
         {
            if(!(_loc7_ = getStyle("dropIndicatorSkin")))
            {
               _loc7_ = ListDropIndicator;
            }
            mx_internal::dropIndicator = IFlexDisplayObject(new _loc7_());
            _loc8_ = viewMetrics;
            drawFocus(true);
            mx_internal::dropIndicator.x = 2;
            if(direction == TileBaseDirection.HORIZONTAL)
            {
               mx_internal::dropIndicator.setActualSize(rowHeight - 4,4);
               DisplayObject(mx_internal::dropIndicator).rotation = 90;
            }
            else
            {
               mx_internal::dropIndicator.setActualSize(columnWidth - 4,4);
            }
         ...
         _loc3_ -= verticalScrollPosition - offscreenExtraRowsTop;
         _loc4_ -= horizontalScrollPosition - offscreenExtraColumnsLeft;
         var _loc5_:Number = listItems.length;
         if(_loc3_ >= _loc5_)
         {
            _loc3_ = _loc5_ - 1;
         }
         var _loc6_:Number = !!_loc5_ ? Number(listItems[0].length) : 0;
         if(_loc4_ > _loc6_)
         {
            _loc4_ = _loc6_;
         }
         mx_internal::dropIndicator.x = _loc6_ && listItems[_loc3_].length && Boolean(listItems[_loc3_][_loc4_]) ? Number(listItems[_loc3_][_loc4_].x) : _loc4_ * columnWidth;
         mx_internal::dropIndicator.y = _loc5_ && listItems[_loc3_].length && Boolean(listItems[_loc3_][0]) ? Number(listItems[_loc3_][0].y) : _loc3_ * rowHeight;
      }
      ...
      override protected function configureScrollBars() : void
      {
         ...
         var _loc11_:int = 0;
         var _loc12_:int = 0;
         var _loc1_:int = int(listItems.length);
         if(_loc1_ == 0)
         {
            return;
         }
         var _loc2_:int = int(listItems[0].length);
         if(_loc2_ == 0)
         {
            return;
         }
         ...
         if(direction == TileBaseDirection.VERTICAL)
         {
            if(iteratorValid && horizontalScrollPosition > 0)
            {
               ...
               if(Boolean(_loc8_) || Boolean(_loc10_))
               {
                  _loc11_ = 0;
            ...
            _loc5_ = maxRows > 0 ? maxRows : _loc1_;
            _loc6_ = !!collection ? int(Math.ceil(collection.length / _loc5_)) : _loc2_;
         }
         else
         {
            ...
            _loc6_ = maxColumns > 0 ? maxColumns : _loc2_;
            _loc5_ = !!collection ? int(Math.ceil(collection.length / _loc6_)) : _loc1_;
         }
      ...
      private function displayingPartialColumn() : Boolean
      {
         ...
         if(Boolean(listItems[0]) && listItems[0].length > 0)
         {
            ...
            if(Boolean(_loc1_) && _loc1_.x + _loc1_.width > listContent.widthExcludingOffsets - listContent.leftOffset)
            {
               return true;
            }
         }
      ...
      override public function itemRendererToIndex(param1:IListItemRenderer) : int
      {
         ...
         {
            _loc5_ = int(listItems[_loc4_].length);
            _loc6_ = 0;
            while(_loc6_ < _loc5_)
            {
               if(Boolean(listItems[_loc4_][_loc6_]) && rowMap[listItems[_loc4_][_loc6_].name].uid == _loc2_)
               {
                  if(direction == TileBaseDirection.VERTICAL)
                  {
      ...
      override public function measureHeightOfItems(param1:int = -1, param2:int = 0) : Number
      {
         ...
         if(Boolean(collection) && Boolean(collection.length))
         {
            _loc8_ = (_loc7_ = iterator.current) is ItemWrapper ? _loc7_.data : _loc7_;
            _loc9_ = getItemRendererFactory(_loc8_);
            if((_loc10_ = measuringObjects[_loc9_]) == null)
            {
               _loc10_ = mx_internal::getMeasuringRenderer(_loc8_);
               _loc4_ = true;
            }
            mx_internal::setupRendererFromData(_loc10_,_loc8_);
            _loc3_ = Number(_loc10_.getExplicitOrMeasuredHeight());
            if(_loc4_)
            {
      ...
      private function getPreparedItemRenderer(param1:int, param2:int, param3:Object, param4:Object, param5:String) : IListItemRenderer
      {
         ...
         if(_loc6_ = listItems[param1][param2])
         {
         ...
         if(!_loc7_)
         {
            ...
            {
               if(!(_loc7_ = visibleData[param5]) && param3 != param4)
               {
            ...
            if(_loc7_)
            {
               if(_loc9_ = ListData(rowMap[_loc7_.name]))
               {
            ...
            if(!_loc7_)
            {
               if((Boolean(_loc7_ = getReservedOrFreeItemRenderer(param3))) && !isRendererUnconstrained(_loc7_))
               {
                  _loc7_.x = 0;
                  _loc7_.y = 0;
               }
         ...
         UIComponentGlobals.mx_internal::layoutManager.validateClient(_loc7_,true);
         return _loc7_;
      }
      ...
      private function placeAndDrawItemRenderer(param1:IListItemRenderer, param2:Number, param3:Number, param4:String) : void
      {
         ...
         var _loc6_:* = false;
         var _loc7_:* = false;
         _loc8_ = Number(param1.getExplicitOrMeasuredHeight());
         if(param1.width != columnWidth || _loc8_ != rowHeight - mx_internal::cachedPaddingTop - mx_internal::cachedPaddingBottom)
         {
            param1.setActualSize(columnWidth,rowHeight - mx_internal::cachedPaddingTop - mx_internal::cachedPaddingBottom);
         }
         if(!isRendererUnconstrained(param1))
         {
            param1.move(param2,param3 + mx_internal::cachedPaddingTop);
         }
         _loc5_ = selectedData[param4] != null;
         if(runningDataEffect)
         {
            _loc5_ = (_loc5_ ||= selectedData[itemToUID(param1.data)] != null) && !getRendererSemanticValue(param1,ModifiedCollectionView.REPLACEMENT) && !getRendererSemanticValue(param1,ModifiedCollectionView.ADDED);
         }
      ...
      override protected function makeRowsAndColumns(param1:Number, param2:Number, param3:Number, param4:Number, param5:int, param6:int, param7:Boolean = false, param8:uint = 0) : Point
      {
         ...
         if(direction == TileBaseDirection.VERTICAL)
         {
            _loc9_ = maxRows > 0 ? maxRows : int(Math.max(Math.floor(listContent.heightExcludingOffsets / rowHeight),1));
            _loc10_ = Math.max(Math.ceil(listContent.widthExcludingOffsets / columnWidth),1);
            setRowCount(_loc9_);
            mx_internal::setColumnCount(_loc10_);
            _loc11_ = param5;
            _loc13_ = param1;
            _loc25_ = _loc11_ - 1;
            ...
            while(param7 && param8-- || !param7 && _loc11_ < _loc10_ + param5)
            {
               ...
               {
                  _loc21_ = _loc20_;
                  _loc16_ = (_loc15_ = _loc20_ ? iterator.current : null) is ItemWrapper ? _loc15_.data : _loc15_;
                  ...
                  {
                     if(_loc18_ = listItems[_loc12_][_loc11_])
                     {
         ...
         {
            _loc10_ = maxColumns > 0 ? maxColumns : int(Math.max(Math.floor(listContent.widthExcludingOffsets / columnWidth),1));
         ...
         if(!param7)
         {
            ...
            if(Boolean(listItems.length) && listItems[0].length > _loc10_ + offscreenExtraColumnsLeft)
            {
               _loc22_ = 0;
      ...
      {
         var _loc2_:int = maxRows > 0 ? maxRows : rowCount;
      ...
      protected function drawTileBackground(param1:Sprite, param2:int, param3:int, param4:Number, param5:Number, param6:uint, param7:IListItemRenderer) : DisplayObject
      {
         ...
         var _loc8_:int;
         if((_loc8_ = param2 * columnCount + param3) < param1.numChildren)
         {
            _loc9_ = Shape(param1.getChildAt(_loc8_));
         }
         else
         {
            (_loc9_ = new FlexShape()).name = "tileBackground";
            param1.addChild(_loc9_);
         }
         var _loc10_:Graphics;
         (_loc10_ = _loc9_.graphics).clear();
      ...
      override public function calculateDropIndex(param1:DragEvent = null) : int
      {
         ...
         if(param1)
         {
            ...
            while(_loc5_ < _loc4_)
            {
               ...
               {
                  _loc6_ = int(listItems[_loc5_].length);
                  _loc7_ = 0;
                  while(_loc7_ < _loc6_)
                  {
      ...
      override public function indicesToIndex(param1:int, param2:int) : int
      {
         ...
         if(direction == TileBaseDirection.VERTICAL)
         {
            _loc4_ = maxRows > 0 ? maxRows : rowCount;
            return param2 * _loc4_ + param1;
         }
         var _loc3_:int = maxColumns > 0 ? maxColumns : columnCount;
      ...
      override protected function adjustListContent(param1:Number = -1, param2:Number = -1) : void
      {
         ...
         if(direction == TileBaseDirection.VERTICAL)
         {
            _loc5_ = maxRows > 0 ? maxRows : int(Math.max(Math.floor(listContent.heightExcludingOffsets / rowHeight),1));
            ...
            if(_loc5_ != lastRowCount)
            {
               ...
               {
                  mx_internal::$horizontalScrollPosition = _loc8_;
               }
               setRowCount(_loc5_);
               mx_internal::setColumnCount(_loc6_);
         ...
         {
            _loc6_ = maxColumns > 0 ? maxColumns : int(Math.max(Math.floor(listContent.widthExcludingOffsets / columnWidth),1));
            ...
            if(_loc6_ != lastColumnCount)
            {
               ...
               {
                  mx_internal::$verticalScrollPosition = _loc9_;
               }
               setRowCount(_loc5_);
               mx_internal::setColumnCount(_loc6_);
