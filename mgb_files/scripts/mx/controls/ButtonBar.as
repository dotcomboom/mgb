package mx.controls
{
   ...
   public class ButtonBar extends NavBar implements IFocusManagerComponent
   {
      ...
      public function ButtonBar()
      {
         super();
         tabEnabled = true;
         mx_internal::navItemFactory = new ClassFactory(ButtonBarButton);
      ...
      override protected function keyUpHandler(param1:KeyboardEvent) : void
      {
         ...
         {
            case Keyboard.SPACE:
               if(mx_internal::focusedIndex != -1)
               {
                  _loc2_ = Button(getChildAt(mx_internal::focusedIndex));
      ...
      mx_internal function nextIndex(param1:int) : int
      {
         ...
         return param1 == _loc2_ - 1 ? 0 : param1 + 1;
      }
      ...
      private function calcFullWidth() : Number
      {
         ...
         var _loc4_:Number = getStyle(mx_internal::buttonWidthProp);
         var _loc5_:IUIComponent = IUIComponent(getChildAt(0));
         if(_loc4_)
         {
            _loc6_ = isNaN(_loc5_.explicitWidth) ? _loc4_ : Number(_loc5_.explicitWidth);
         }
         else
         {
            _loc6_ = Number(_loc5_.getExplicitOrMeasuredWidth());
         }
         var _loc7_:int = 1;
         while(_loc7_ < _loc1_)
         {
            ...
            if(_loc4_)
            {
               _loc8_ = isNaN(_loc5_.explicitWidth) ? _loc4_ : Number(_loc5_.explicitWidth);
            }
            else
            {
               _loc8_ = Number(_loc5_.getExplicitOrMeasuredWidth());
            }
            if(_loc3_)
            {
      ...
      {
         if(mx_internal::simulatedClickTriggerEvent == null)
         {
            mx_internal::focusedIndex = getChildIndex(DisplayObject(param1.currentTarget));
            mx_internal::drawButtonFocus(mx_internal::focusedIndex,true);
         }
      ...
      {
         var _loc3_:Button = Button(mx_internal::navItemFactory.newInstance());
      ...
      override public function styleChanged(param1:String) : void
      {
         ...
         if(_loc2_ || param1 == mx_internal::buttonStyleNameProp || param1 == mx_internal::firstButtonStyleNameProp || param1 == mx_internal::lastButtonStyleNameProp)
         {
            resetNavItems();
         }
         else if(param1 == mx_internal::buttonWidthProp)
         {
            recalcButtonWidths = true;
         }
         else if(param1 == mx_internal::buttonHeightProp)
         {
      ...
      override protected function commitProperties() : void
      {
         ...
         if(directionChanged)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               Button(getChildAt(_loc2_)).mx_internal::changeSkins();
               _loc2_++;
            }
         }
      ...
      private function calcFullHeight() : Number
      {
         ...
         var _loc4_:Number = getStyle(mx_internal::buttonHeightProp);
         var _loc5_:IUIComponent = IUIComponent(getChildAt(0));
         if(_loc4_)
         {
            _loc6_ = isNaN(_loc5_.explicitHeight) ? _loc4_ : Number(_loc5_.explicitHeight);
         }
         else
         {
            _loc6_ = Number(_loc5_.getExplicitOrMeasuredHeight());
         }
         var _loc7_:int = 1;
         while(_loc7_ < _loc1_)
         {
            ...
            if(_loc4_)
            {
               _loc8_ = isNaN(_loc5_.explicitHeight) ? _loc4_ : Number(_loc5_.explicitHeight);
            }
            else
            {
               _loc8_ = Number(_loc5_.getExplicitOrMeasuredHeight());
            }
            if(_loc3_)
            {
               _loc6_ += _loc2_ + _loc8_;
      ...
      override protected function resetNavItems() : void
      {
         ...
         var _loc1_:String = getStyle(mx_internal::buttonStyleNameProp);
         var _loc2_:String = getStyle(mx_internal::firstButtonStyleNameProp);
         var _loc3_:String = getStyle(mx_internal::lastButtonStyleNameProp);
         if(!_loc1_)
         {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            _loc4_.mx_internal::changeSkins();
      ...
      {
         var _loc2_:int = numChildren;
         return param1 == 0 ? _loc2_ - 1 : param1 - 1;
      }
      ...
      mx_internal function drawButtonFocus(param1:int, param2:Boolean) : void
      {
         ...
         if(numChildren > 0 && param1 < numChildren)
         {
            ...
            _loc3_.drawFocus(param2 && Boolean(focusManager.showFocusIndicator));
            if(param2)
            {
               dispatchEvent(new Event("focusDraw"));
            }
            if(!param2 && _loc3_.mx_internal::phase != ButtonPhase.UP)
            {
               _loc3_.mx_internal::phase = ButtonPhase.UP;
            }
         }
      }
      ...
      override protected function keyDownHandler(param1:KeyboardEvent) : void
      {
         ...
         switch(param1.keyCode)
         {
            ...
            case Keyboard.RIGHT:
               ...
               mx_internal::drawButtonFocus(mx_internal::focusedIndex,false);
               mx_internal::focusedIndex = mx_internal::nextIndex(mx_internal::focusedIndex);
               if(mx_internal::focusedIndex != -1)
               {
                  mx_internal::drawButtonFocus(mx_internal::focusedIndex,true);
               }
            ...
            case Keyboard.LEFT:
               focusManager.showFocusIndicator = true;
               mx_internal::drawButtonFocus(mx_internal::focusedIndex,false);
               mx_internal::focusedIndex = mx_internal::prevIndex(mx_internal::focusedIndex);
               if(mx_internal::focusedIndex != -1)
               {
                  mx_internal::drawButtonFocus(mx_internal::focusedIndex,true);
               }
      ...
      override protected function measure() : void
      {
         ...
         if(getStyle(mx_internal::buttonWidthProp))
         {
            measuredMinWidth = measuredWidth;
         }
         if(getStyle(mx_internal::buttonHeightProp))
         {
      ...
      private function childRemoveHandler(param1:ChildExistenceChangedEvent) : void
      {
         ...
         var _loc5_:String = getStyle(mx_internal::buttonStyleNameProp);
         var _loc6_:String = getStyle(mx_internal::firstButtonStyleNameProp);
         var _loc7_:String = getStyle(mx_internal::lastButtonStyleNameProp);
         if(!_loc5_)
         {
         ...
         {
            (_loc8_ = Button(getChildAt(_loc3_ == _loc4_ - 1 ? _loc4_ - 2 : 0))).styleName = _loc3_ == 0 ? _loc6_ : _loc7_;
            _loc8_.mx_internal::changeSkins();
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         var _loc4_:* = !_loc3_;
         var _loc5_:Number = getStyle(mx_internal::buttonWidthProp);
         var _loc6_:Number;
         var _loc7_:Number = _loc6_ = getStyle(mx_internal::buttonHeightProp);
         ...
         var _loc12_:Number = _loc3_ && numChildren > 0 ? _loc10_ * (_loc9_ - 1) : 0;
         var _loc13_:Number = _loc4_ && numChildren > 0 ? _loc11_ * (_loc9_ - 1) : 0;
         ...
         if(recalcButtonWidths)
         {
            ...
            while(_loc16_ < _loc9_)
            {
               ...
               if(isNaN(_loc17_.explicitWidth))
               {
                  ...
                  {
                     if((_loc24_ = _loc17_.measuredWidth) > _loc19_)
                     {
         ...
         if(recalcButtonHeights)
         {
            ...
            if(_loc18_ != 0 && _loc4_)
            {
               ...
               while(_loc16_ < _loc9_)
               {
                  ...
                  {
                     _loc25_ += _loc17_.measuredHeight;
                  }
                  _loc16_++;
               }
            }
      ...
      {
         mx_internal::drawButtonFocus(mx_internal::focusedIndex,param1);
      }
