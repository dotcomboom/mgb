package mx.controls.dataGridClasses
{
   ...
   public class DataGridBase extends ListBase implements IFontContextComponent
   {
      ...
      {
         mx_internal::headerClass = DataGridHeader;
      ...
      override mx_internal function removeClipMask() : void
      {
         ...
         var _loc1_:int = int(listItems.length - 1);
         if(_loc1_ < 0)
         {
            return;
         }
         ...
         var _loc4_:Array;
         if(_loc4_ = lockedColumnContent.listItems[_loc1_])
         {
      ...
      override protected function shiftRow(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         if(lockedColumnCount)
         {
            param3 = int((_loc5_ = lockedColumnContent.listItems)[param1].length);
            _loc7_ = 0;
            while(_loc7_ < param3)
            {
      ...
      protected function makeRow(param1:ListBaseContentHolder, param2:int, param3:Number, param4:Number, param5:Number, param6:Object, param7:String) : Number
      {
         ...
         while(_loc14_ < mx_internal::visibleLockedColumns.length)
         {
            _loc12_ = mx_internal::visibleLockedColumns[_loc14_];
         ...
         _loc14_ = 0;
         _loc15_ = param3;
         while(_loc15_ < param4 && _loc14_ < mx_internal::visibleColumns.length)
         {
            _loc12_ = mx_internal::visibleColumns[_loc14_];
      ...
      {
         return mx_internal::_headerHeight;
      }
      ...
      override mx_internal function addClipMask(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            if(horizontalScrollBar && horizontalScrollBar.visible || mx_internal::hasOnlyTextRenderers() || listContent.bottomOffset != 0 || listContent.topOffset != 0 || listContent.leftOffset != 0 || listContent.rightOffset != 0)
            {
               ...
               header.mx_internal::selectionLayer.mask = null;
               ...
               if(lockedColumnHeader)
               {
                  ...
                  lockedColumnHeader.mx_internal::selectionLayer.mask = null;
            ...
            else
            {
               ...
               header.mask = null;
               header.mx_internal::selectionLayer.mask = headerMask;
               headerMask.width = maskShape.width;
               headerMask.height = maskShape.height;
               headerMask.x = maskShape.x;
               headerMask.y = maskShape.y;
               ...
               if(lockedColumnHeader)
               {
                  ...
                  lockedColumnHeader.mx_internal::selectionLayer.mask = lockedColumnHeaderMask;
                  lockedColumnHeaderMask.width = maskShape.width;
                  lockedColumnHeaderMask.height = maskShape.height;
                  lockedColumnHeaderMask.x = maskShape.x;
                  lockedColumnHeaderMask.y = maskShape.y;
         ...
         var _loc3_:int = int(listItems.length - 1);
         ...
         {
            _loc12_ = (_loc11_ = _loc5_[_loc10_]).y - _loc7_;
         ...
         if(lockedColumnContent)
         {
            _loc6_ = int((_loc5_ = lockedColumnContent.listItems[_loc3_]).length);
            ...
            while(_loc10_ < _loc6_)
            {
               ...
               {
                  _loc11_.mask = mx_internal::createItemMask(0,_loc7_ + _loc12_,_loc8_,Math.max(_loc9_ - _loc12_,0),lockedColumnContent);
               }
               _loc10_++;
            }
         }
      ...
      {
         mx_internal::_headerHeight = param1;
      ...
      protected function layoutColumnItemRenderer(param1:DataGridColumn, param2:IListItemRenderer, param3:Number, param4:Number) : Point
      {
         ...
         if(param2)
         {
            param2.explicitWidth = _loc5_ = mx_internal::getWidthOfItem(param2,param1);
      ...
      override public function showDropFeedback(param1:DragEvent) : void
      {
         ...
         if(Boolean(lockedRowCount) && _loc2_ < lockedRowCount)
         {
            if(mx_internal::dropIndicator.parent != lockedRowContent)
            {
               lockedRowContent.addChild(DisplayObject(mx_internal::dropIndicator));
            }
            mx_internal::dropIndicator.y = lockedRowContent.listItems[_loc2_][0].y - 1;
         }
         else
         {
            _loc6_ = (_loc5_ = int(listItems.length)) > 0 && rowInfo[_loc5_ - offscreenExtraRowsBottom - 1].y + rowInfo[_loc5_ - offscreenExtraRowsBottom - 1].height > listContent.heightExcludingOffsets - listContent.topOffset ? 1 : 0;
            _loc2_ -= verticalScrollPosition + lockedRowCount;
            if(_loc2_ >= _loc5_)
            {
               if(_loc6_)
               {
      ...
      override protected function moveIndicatorsVertically(param1:String, param2:Number) : void
      {
         ...
         if(lockedColumnCount)
         {
            if(param1)
            {
               ...
               {
                  columnHighlightIndicator.y += param2;
               }
               if(caretUID == param1)
               {
                  columnCaretIndicator.y += param2;
               }
            }
         }
      }
      ...
      mx_internal function getAllVisibleColumns() : Array
      {
         ...
         if(lockedColumnCount)
         {
            _loc1_ = _loc1_.concat(mx_internal::visibleLockedColumns);
         }
         return _loc1_.concat(mx_internal::visibleColumns);
      }
      ...
      override protected function drawSelectionIndicator(param1:Sprite, param2:Number, param3:Number, param4:Number, param5:Number, param6:uint, param7:IListItemRenderer) : void
      {
         ...
         if(lockedColumnCount)
         {
            ...
            _loc9_ = _loc8_.selectionLayer;
            if(!(_loc10_ = indicatorDictionary[param1] as Sprite))
            {
               (_loc10_ = new SpriteAsset()).mouseEnabled = false;
      ...
      override protected function clearIndicators() : void
      {
         ...
         if(Boolean(lockedColumnCount) && Boolean(lockedColumnContent))
         {
         ...
         if(Boolean(lockedRowCount) && Boolean(lockedRowContent))
         {
            ...
            if(Boolean(lockedColumnCount) && Boolean(lockedColumnAndRowContent))
            {
         ...
         if(header)
         {
            header.mx_internal::clearSelectionLayer();
         }
         if(lockedColumnHeader)
         {
            lockedColumnHeader.mx_internal::clearSelectionLayer();
         }
      }
      ...
      override protected function drawItem(param1:IListItemRenderer, param2:Boolean = false, param3:Boolean = false, param4:Boolean = false, param5:Boolean = false) : void
      {
         ...
         _loc7_ = 0;
         while(_loc7_ < mx_internal::visibleColumns.length)
         {
         ...
         if(lockedColumnCount)
         {
            ...
            _loc7_ = 0;
            while(_loc7_ < mx_internal::visibleLockedColumns.length)
            {
      ...
      override protected function adjustAfterRemove(param1:Array, param2:int, param3:Boolean) : Boolean
      {
         ...
         if(lockedRowCount && listItems.length && Boolean(listItems[0].length))
         {
      ...
      override protected function destroyRow(param1:int, param2:int) : void
      {
         ...
         if(lockedColumnCount)
         {
            ...
            _loc7_ = String(_loc4_[param1].uid);
            removeIndicators(_loc7_);
            _loc8_ = 0;
            while(_loc8_ < param2)
            {
               if((_loc6_ = _loc3_[param1][_loc8_]).data)
               {
      ...
      public function createColumnItemRenderer(param1:DataGridColumn, param2:Boolean, param3:Object) : IListItemRenderer
      {
         ...
         if(!(_loc4_ = param1.getItemRendererFactory(param2,param3)))
         {
            if(!param3)
            {
         ...
         {
            if(Boolean(freeItemRenderersTable[param1]) && Boolean(freeItemRenderersTable[param1].length))
            {
         ...
         {
            if(_loc6_ = param1.mx_internal::freeItemRenderersByFactory[_loc4_])
            {
               var _loc8_:int = 0;
               var _loc9_:* = _loc6_;
      ...
      override protected function addToFreeItemRenderers(param1:IListItemRenderer) : void
      {
         ...
         var _loc4_:Object;
         if((_loc4_ = ListBaseContentHolder(param1.parent).visibleData)[_loc3_] == param1)
         {
         ...
         switch(param1)
         {
            ...
            case Keyboard.DOWN:
               if(caretIndex >= lockedRowCount - 1)
               {
                  ...
                  else if(caretIndex == collection.length - 1 && Boolean(_loc11_))
                  {
      ...
      override protected function set allowItemSizeChangeNotification(param1:Boolean) : void
      {
         if(lockedColumnContent)
         {
            lockedColumnContent.mx_internal::allowItemSizeChangeNotification = param1;
         }
         if(lockedRowContent)
         {
            lockedRowContent.mx_internal::allowItemSizeChangeNotification = param1;
         }
         if(lockedColumnAndRowContent)
         {
            lockedColumnAndRowContent.mx_internal::allowItemSizeChangeNotification = param1;
         }
      ...
      override protected function moveRowVertically(param1:int, param2:int, param3:Number) : void
      {
         ...
         if(lockedColumnCount)
         {
            param2 = int((_loc4_ = lockedColumnContent.listItems)[param1].length);
      ...
      override mx_internal function mouseEventToItemRendererOrEditor(param1:MouseEvent) : IListItemRenderer
      {
         ...
         {
            _loc4_ = lockedColumnContent;
            _loc5_ = mx_internal::visibleLockedColumns;
         }
      ...
      protected function drawVisibleItem(param1:String, param2:Boolean = false, param3:Boolean = false, param4:Boolean = false, param5:Boolean = false) : void
      {
         ...
         if(lockedRowCount && lockedRowContent && Boolean(lockedRowContent.visibleData[param1]))
         {
      ...
      protected function setupColumnItemRenderer(param1:DataGridColumn, param2:ListBaseContentHolder, param3:int, param4:int, param5:Object, param6:String) : IListItemRenderer
      {
         ...
         var _loc7_:Array;
         if(!(_loc8_ = (_loc7_ = param2.listItems)[param3][param4]) || itemToUID(_loc8_.data) != param6 || columnMap[_loc8_.name] != param1)
         {
            if((_loc8_ = createColumnItemRenderer(param1,false,param5)) == null)
            {
               return null;
            }
         ...
         _loc9_ = DataGridListData(makeListData(param5,param6,param3,param1.mx_internal::colNum,param1));
      ...
      {
         mx_internal::_lockedColumnCount = param1;
      ...
      protected function makeRows(param1:ListBaseContentHolder, param2:Number, param3:Number, param4:Number, param5:Number, param6:int, param7:int, param8:Boolean = false, param9:uint = 0, param10:Boolean = false) : Point
      {
         ...
         if((!mx_internal::visibleColumns || mx_internal::visibleColumns.length == 0) && lockedColumnCount == 0)
         {
            while(listItems.length)
            {
               rowNum = int(listItems.length - 1);
      ...
      {
         return mx_internal::_lockedColumnCount;
      }
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(lockedColumnCountChanged)
         {
            ...
            if(lockedColumnCount > 0)
            {
               if(!lockedColumnContent)
               {
                  lockedColumnHeader = new mx_internal::headerClass();
         ...
         if(lockedRowCountChanged && Boolean(iterator))
         {
         ...
         if(Boolean(lockedRowContent) && Boolean(lockedColumnAndRowContent))
         {
         ...
         if(Boolean(lockedColumnContent) && Boolean(lockedColumnAndRowContent))
         {
            _loc4_ = getChildIndex(lockedColumnAndRowContent);
         ...
         if(mx_internal::headerVisible && Boolean(lockedColumnHeader))
         {
            lockedColumnHeader.mx_internal::visibleColumns = mx_internal::visibleLockedColumns;
