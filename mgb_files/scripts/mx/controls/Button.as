package mx.controls
{
   ...
   public class Button extends UIComponent implements IDataRenderer, IDropInListItemRenderer, IFocusManagerComponent, IListItemRenderer, IFontContextComponent, IButton
   {
      ...
      mx_internal static var TEXT_WIDTH_PADDING:Number = UITextField.mx_internal::TEXT_WIDTH_PADDING + 1;
      ...
      {
         var _loc1_:int = int(icons.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      mx_internal function layoutContents(param1:Number, param2:Number, param3:Boolean) : void
      {
         ...
         {
            _loc8_ = Number(mx_internal::currentIcon.width);
            _loc9_ = Number(mx_internal::currentIcon.height);
         }
         if(labelPlacement == ButtonLabelPlacement.LEFT || labelPlacement == ButtonLabelPlacement.RIGHT)
         {
      ...
      {
         var _loc1_:int = int(skins.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         var _loc3_:int = int(skins.length);
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
