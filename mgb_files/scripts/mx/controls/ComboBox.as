   ...
   public class ComboBox extends ComboBase implements IDataRenderer, IDropInListItemRenderer, IListItemRenderer
   {
      ...
      override protected function collectionChangeHandler(param1:Event) : void
      {
         ...
         if(param1 is CollectionEvent)
         {
            ...
            {
               if(!mx_internal::selectedIndexChanged && !mx_internal::selectedItemChanged)
               {
      ...
      private function getDropdown() : ListBase
      {
         ...
         if(!mx_internal::hasDropdown())
         {
            ...
            UIComponentGlobals.mx_internal::layoutManager.validateClient(_dropdown,true);
      ...
      {
         if(ComboBox.mx_internal::createAccessibilityImplementation != null)
         {
            ComboBox.mx_internal::createAccessibilityImplementation(this);
         }
      }
      ...
      {
         explicitText = mx_internal::textChanged;
      ...
      override public function set selectedIndex(param1:int) : void
      {
         ...
         implicitSelectedIndex = false;
         invalidateDisplayList();
         if(textInput && !mx_internal::textChanged && param1 >= 0)
         {
      ...
      private function displayDropdown(param1:Boolean, param2:Event = null, param3:Boolean = true) : void
      {
         ...
         var _loc10_:DisplayObject = (_loc9_ = systemManager.topLevelSystemManager).getSandboxRoot();
         if(_loc9_ != _loc10_)
         {
         ...
         if(param1)
         {
            ...
            {
               _loc8_.y -= unscaledHeight + _dropdown.height;
            ...
            if((_loc13_ = _dropdown.selectedIndex) == -1)
            {
               _loc13_ = 0;
            }
         ...
         {
            _loc5_ = _loc8_.y + _dropdown.height > _loc11_.bottom || tweenUp ? -_dropdown.height : _dropdown.height;
            _showingDropdown = param1;
            _loc4_ = 0;
            _loc6_ = getStyle("closeDuration");
            _loc7_ = getStyle("closeEasingFunction") as Function;
            _dropdown.mx_internal::resetDragScrolling();
         }
         inTween = true;
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(mx_internal::selectionChanged)
         {
            ...
            if(editable)
            {
               textInput.mx_internal::getTextField().setSelection(0,textInput.text.length);
               textInput.mx_internal::getTextField().scrollH = 0;
            }
            if(_dropdown)
            {
               _dropdown.selectedIndex = selectedIndex;
