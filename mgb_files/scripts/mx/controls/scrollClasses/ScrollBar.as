package mx.controls.scrollClasses
{
   ...
   public class ScrollBar extends UIComponent
   {
      ...
      private function scrollTrack_mouseDownHandler(param1:MouseEvent) : void
      {
         ...
         trackScrollRepeatDirection = mx_internal::scrollThumb.y + mx_internal::scrollThumb.height < _loc3_.y ? 1 : (mx_internal::scrollThumb.y > _loc3_.y ? -1 : 0);
      ...
      public function set scrollPosition(param1:Number) : void
      {
         ...
         if(mx_internal::scrollThumb)
         {
            ...
            if(!mx_internal::isScrolling)
            {
               ...
               _loc4_ = (mx_internal::virtualWidth - mx_internal::scrollThumb.width) / 2 + getStyle("thumbOffset");
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(FlexVersion.compatibilityVersion >= FlexVersion.VERSION_3_0)
         {
            mx_internal::upArrow.move((mx_internal::virtualWidth - mx_internal::upArrow.width) / 2,0);
         }
         else
         {
         ...
         if(FlexVersion.compatibilityVersion >= FlexVersion.VERSION_3_0)
         {
            mx_internal::scrollTrack.x = (mx_internal::virtualWidth - mx_internal::scrollTrack.width) / 2;
         }
         ...
         if(FlexVersion.compatibilityVersion >= FlexVersion.VERSION_3_0)
         {
            mx_internal::downArrow.move((mx_internal::virtualWidth - mx_internal::downArrow.width) / 2,mx_internal::virtualHeight - mx_internal::downArrow.getExplicitOrMeasuredHeight());
         }
         else
         {
