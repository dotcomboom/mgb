   ...
   public class Slider extends UIComponent
   {
      ...
      override protected function commitProperties() : void
      {
         ...
         if(trackHighlightChanged)
         {
            ...
            {
               mx_internal::innerSlider.removeChild(DisplayObject(highlightTrack));
               highlightTrack = null;
            }
         }
         if(directionChanged)
         {
            ...
            if(_loc3_)
            {
               DisplayObject(mx_internal::innerSlider).rotation = 0;
            }
            else
            {
               DisplayObject(mx_internal::innerSlider).rotation = -90;
               mx_internal::innerSlider.y = unscaledHeight;
            }
            if(labelObjects)
            {
               ...
               while(_loc4_ >= 0)
               {
                  (_loc5_ = SliderLabel(labelObjects.getChildAt(_loc4_))).rotation = _loc3_ ? 0 : 90;
                  _loc4_--;
               }
            }
         }
         ...
         if(snapIntervalChanged)
         {
            ...
            if(!valuesChanged)
            {
               ...
               while(_loc2_ < _loc1_)
               {
                  setValueAt(mx_internal::getValueFromX(SliderThumb(thumbs.getChildAt(_loc2_)).xPosition),_loc2_);
                  _loc2_++;
               }
            }
         }
         if(valuesChanged)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               setValueAt(mx_internal::getValueFromX(mx_internal::getXFromValue(Math.min(Math.max(values[_loc2_],minimum),maximum))),_loc2_);
               _loc2_++;
            }
         }
         if(enabledChanged)
         {
            ...
            _loc1_ = !!labelObjects ? labelObjects.numChildren : 0;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
      ...
      mx_internal function getSnapValue(param1:Number, param2:SliderThumb = null) : Number
      {
         ...
         {
            _loc3_ = mx_internal::getValueFromX(param1);
            if(param2 && thumbs.numChildren > 1 && !allowThumbOverlap)
            {
               _loc4_ = true;
               _loc5_ = mx_internal::getXBounds(param2.mx_internal::thumbIndex);
               _loc6_ = param2.mx_internal::thumbIndex > 0 ? SliderThumb(thumbs.getChildAt(param2.mx_internal::thumbIndex - 1)) : null;
               _loc7_ = param2.mx_internal::thumbIndex + 1 < thumbs.numChildren ? SliderThumb(thumbs.getChildAt(param2.mx_internal::thumbIndex + 1)) : null;
               if(_loc6_)
               {
                  _loc5_.min -= _loc6_.width / 2;
                  if(_loc3_ == minimum)
                  {
                     if(mx_internal::getValueFromX(_loc6_.xPosition - _loc6_.width / 2) != minimum)
                     {
                        _loc4_ = false;
                     }
                  }
               ...
               if(_loc7_)
               {
                  ...
                  if(_loc3_ == maximum)
                  {
                     if(mx_internal::getValueFromX(_loc7_.xPosition + _loc7_.width / 2) != maximum)
                     {
                        _loc4_ = false;
                     }
                  }
               ...
               if(_loc4_)
               {
                  _loc3_ = Math.min(Math.max(_loc3_,mx_internal::getValueFromX(Math.round(_loc5_.min)) + _snapInterval),mx_internal::getValueFromX(Math.round(_loc5_.max)) - _snapInterval);
               }
            }
            return mx_internal::getXFromValue(_loc3_);
         }
         return param1;
      }
      ...
      private function createHighlightTrack() : void
      {
         ...
         if(!highlightTrack && _loc1_)
         {
            ...
            mx_internal::innerSlider.addChildAt(DisplayObject(highlightTrack),mx_internal::innerSlider.getChildIndex(DisplayObject(track)) + 1);
         }
      }
      ...
      mx_internal function drawTrackHighlight() : void
      {
         ...
         if(highlightTrack)
         {
            ...
            if(_thumbCount > 1)
            {
               ...
               _loc2_ = (_loc4_ = SliderThumb(thumbs.getChildAt(1))).xPosition - _loc3_.xPosition;
            }
            else
            {
               _loc1_ = Number(track.x);
               _loc2_ = _loc3_.xPosition - _loc1_;
            }
            highlightTrack.move(_loc1_,track.y + 1);
            highlightTrack.setActualSize(_loc2_ > 0 ? _loc2_ : 0,highlightTrack.height);
         }
      }
      ...
      mx_internal function getXBounds(param1:int) : Object
      {
         ...
         var _loc3_:Number = Number(track.x);
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         var _loc4_:int = !!labelObjects ? labelObjects.numChildren : 0;
         var _loc5_:int = !!thumbs ? thumbs.numChildren : 0;
         ...
         {
            mx_internal::innerSlider.y = param2;
         }
         layoutTicks();
         layoutLabels();
         setPosFromValue();
         mx_internal::drawTrackHighlight();
      }
      
      override protected function createChildren() : void
      {
         super.createChildren();
         if(!mx_internal::innerSlider)
         {
            mx_internal::innerSlider = new UIComponent();
            UIComponent(mx_internal::innerSlider).tabChildren = true;
            addChild(mx_internal::innerSlider);
         }
         createBackgroundTrack();
         if(!trackHitArea)
         {
            trackHitArea = new UIComponent();
            mx_internal::innerSlider.addChild(trackHitArea);
      ...
      private function createBackgroundTrack() : void
      {
         ...
         if(!track)
         {
            ...
            mx_internal::innerSlider.addChildAt(DisplayObject(track),0);
         }
      }
      ...
      private function positionDataTip(param1:Object) : void
      {
         ...
         if(_direction == SliderDirection.HORIZONTAL)
         {
            ...
            if(_loc6_ == "left")
            {
               _loc2_ -= _loc7_ + mx_internal::dataTip.width;
               _loc3_ += (param1.height - mx_internal::dataTip.height) / 2;
            }
            ...
            {
               _loc3_ -= _loc7_ + mx_internal::dataTip.height;
               _loc2_ -= (mx_internal::dataTip.width - param1.width) / 2;
            }
         ...
         {
            _loc2_ = _loc5_;
            _loc3_ = unscaledHeight - _loc4_ - (mx_internal::dataTip.height + param1.width) / 2;
            if(_loc6_ == "left")
            {
               _loc2_ -= _loc7_ + mx_internal::dataTip.width;
            }
            ...
            {
               _loc3_ -= _loc7_ + (mx_internal::dataTip.height + param1.width) / 2;
               _loc2_ -= (mx_internal::dataTip.width - param1.height) / 2;
            }
            else if(_loc6_ == "bottom")
            {
               _loc3_ += _loc7_ + (mx_internal::dataTip.height + param1.width) / 2;
         ...
         _loc9_ = mx_internal::dataTip.parent.globalToLocal(_loc9_);
         mx_internal::dataTip.x = _loc9_.x < 0 ? 0 : _loc9_.x;
         mx_internal::dataTip.y = _loc9_.y < 0 ? 0 : _loc9_.y;
      }
      ...
      private function createLabels() : void
      {
         ...
         else
         {
            ...
            mx_internal::innerSlider.addChildAt(labelObjects,mx_internal::innerSlider.getChildIndex(trackHitArea));
         }
         if(_labels)
         {
            _loc3_ = int(_labels.length);
            _loc4_ = 0;
            while(_loc4_ < _loc3_)
            {
               _loc1_ = new SliderLabel();
               _loc1_.text = _labels[_loc4_] is String ? String(_labels[_loc4_]) : String(_labels[_loc4_].toString());
               if(_direction != SliderDirection.HORIZONTAL)
               {
                  _loc1_.rotation = 90;
               }
      ...
      private function setValueFromPos(param1:int) : void
      {
         ...
         setValueAt(mx_internal::getValueFromX(_loc2_.xPosition),param1);
      }
      ...
      mx_internal function onThumbPress(param1:Object) : void
      {
         ...
         if(showDataTip)
         {
            ...
            if(!mx_internal::dataTip)
            {
               ...
               {
                  mx_internal::dataTip.styleName = _loc4_;
               }
            }
            if(_dataTipFormatFunction != null)
            {
               _loc3_ = this._dataTipFormatFunction(mx_internal::getValueFromX(param1.xPosition));
            }
            else
            {
               _loc3_ = dataFormatter.format(mx_internal::getValueFromX(param1.xPosition));
            }
            mx_internal::dataTip.text = _loc3_;
         ...
         _loc2_.value = mx_internal::getValueFromX(param1.xPosition);
      ...
      {
         mx_internal::innerSlider.removeEventListener(MouseEvent.MOUSE_MOVE,param1);
      }
      ...
      private function layoutTicks() : void
      {
         ...
         if(ticks)
         {
            ...
            _loc8_ = 0;
            _loc9_ = _loc7_ ? Number(_tickValues[_loc8_++]) : minimum;
            _loc1_.clear();
            if(_tickInterval > 0 || _loc7_)
            {
               ...
               do
               {
                  _loc5_ = Math.round(mx_internal::getXFromValue(_loc9_));
                  _loc1_.moveTo(_loc5_,_loc2_);
                  _loc1_.lineTo(_loc5_,0);
               }
               while((_loc9_ = _loc7_ ? (_loc8_ < _tickValues.length ? Number(_tickValues[_loc8_++]) : NaN) : _tickInterval + _loc9_) < maximum || _loc7_ && _loc8_ < _tickValues.length);
      ...
      private function setPosFromValue() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            _loc3_.xPosition = mx_internal::getXFromValue(values[_loc2_]);
            _loc2_++;
         }
      }
      ...
      private function createThumbs() : void
      {
         ...
         else
         {
            ...
            mx_internal::innerSlider.addChild(thumbs);
         }
         _loc1_ = _thumbCount;
         _loc2_ = 0;
         while(_loc2_ < _loc1_)
      ...
      override protected function measure() : void
      {
         ...
         var _loc2_:int = !!labelObjects ? labelObjects.numChildren : 0;
         ...
         if(!isNaN(_loc3_))
         {
            if(_loc2_ > 0)
            {
               _loc4_ += _loc1_ ? SliderLabel(labelObjects.getChildAt(0)).getExplicitOrMeasuredWidth() / 2 : SliderLabel(labelObjects.getChildAt(0)).getExplicitOrMeasuredHeight() / 2;
            }
            if(_loc2_ > 1)
            {
               _loc4_ += _loc1_ ? SliderLabel(labelObjects.getChildAt(_loc2_ - 1)).getExplicitOrMeasuredWidth() / 2 : SliderLabel(labelObjects.getChildAt(_loc2_ - 1)).getExplicitOrMeasuredHeight() / 2;
            }
         }
         var _loc5_:Object;
         _loc6_ = (_loc5_ = getComponentBounds()).lower - _loc5_.upper;
      ...
      {
         if(Slider.mx_internal::createAccessibilityImplementation != null)
         {
      ...
      {
         mx_internal::innerSlider.addEventListener(MouseEvent.MOUSE_MOVE,param1);
      }
      ...
      override public function styleChanged(param1:String) : void
      {
         ...
         {
            if(Boolean(mx_internal::innerSlider) && Boolean(highlightTrack))
            {
               mx_internal::innerSlider.removeChild(DisplayObject(highlightTrack));
               highlightTrack = null;
            }
         ...
         if(param1 == "trackSkin" || _loc2_)
         {
            if(track)
            {
               mx_internal::innerSlider.removeChild(DisplayObject(track));
               track = null;
               createBackgroundTrack();
            }
         }
      ...
      {
         var _loc2_:Number = mx_internal::getValueFromX(param1.xPosition);
         if(showDataTip)
         {
            mx_internal::dataTip.text = _dataTipFormatFunction != null ? _dataTipFormatFunction(_loc2_) : dataFormatter.format(_loc2_);
            mx_internal::dataTip.setActualSize(mx_internal::dataTip.getExplicitOrMeasuredWidth(),mx_internal::dataTip.getExplicitOrMeasuredHeight());
            positionDataTip(param1);
         }
         if(liveDragging)
      ...
      private function layoutLabels() : void
      {
         ...
         var _loc9_:Number = NaN;
         var _loc1_:Number = !!labelObjects ? labelObjects.numChildren : 0;
         if(_loc1_ > 0)
         {
      ...
      private function getComponentBounds() : Object
      {
         ...
         var _loc4_:Number = 0;
         var _loc6_:Number = 0;
         var _loc7_:Number = Number(track.height);
         if(_loc2_ > 0)
         {
      ...
      private function track_mouseDownHandler(param1:MouseEvent) : void
      {
         ...
         if(enabled && allowTrackClick)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               if((_loc12_ = Math.abs(SliderThumb(thumbs.getChildAt(_loc7_)).xPosition - _loc3_)) < _loc5_)
               {
                  _loc4_ = _loc7_;
                  _loc5_ = _loc12_;
               }
            ...
            if(!isNaN(_snapInterval) && _snapInterval != 0)
            {
               _loc3_ = mx_internal::getXFromValue(mx_internal::getValueFromX(_loc3_));
            }
      ...
      private function createTicks() : void
      {
         if(!ticks)
         {
            ...
            mx_internal::innerSlider.addChild(ticks);
         }
      }
      ...
      private function setValueAt(param1:Number, param2:int, param3:Boolean = false) : void
      {
         ...
         var _loc4_:Number = Number(_values[param2]);
