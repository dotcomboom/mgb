package mx.controls
{
   ...
   public class RadioButtonGroup extends EventDispatcher implements IMXMLObject
   {
      ...
      public function get enabled() : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc1_ += getRadioButtonAt(_loc3_).enabled;
            _loc3_++;
         }
         if(_loc1_ == 0)
         {
      ...
      private function radioButton_removedHandler(param1:Event) : void
      {
         ...
         if(_loc2_)
         {
            ...
            mx_internal::removeInstance(RadioButton(param1.target));
         }
      }
      ...
      public function set selectedValue(param1:Object) : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc4_ = getRadioButtonAt(_loc3_)).value == param1 || _loc4_.label == param1)
            {
      ...
      {
         param1.mx_internal::indexNumber = indexNumber++;
      ...
      mx_internal function removeInstance(param1:RadioButton) : void
      {
         ...
         if(param1)
         {
            ...
            while(_loc3_ < numRadioButtons)
            {
               ...
               if(_loc2_)
               {
                  --_loc4_.mx_internal::indexNumber;
               }
