package mx.controls
{
   ...
   public class ToggleButtonBar extends ButtonBar
   {
      ...
      override public function styleChanged(param1:String) : void
      {
         ...
         if(_loc2_ || param1 == mx_internal::selectedButtonTextStyleNameProp)
         {
            if(selectedIndex != -1 && selectedIndex < numChildren)
            {
               ...
               if(_loc3_)
               {
                  _loc4_ = getStyle(mx_internal::selectedButtonTextStyleNameProp);
                  _loc3_.mx_internal::getTextField().styleName = !!_loc4_ ? _loc4_ : "activeButtonStyle";
               }
            }
         }
      }
      ...
      override protected function resetNavItems() : void
      {
         ...
         var _loc1_:String = getStyle(mx_internal::selectedButtonTextStyleNameProp);
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            if(_loc3_ == selectedIndex)
            {
               ...
               _loc4_.mx_internal::getTextField().styleName = !!_loc1_ ? _loc1_ : "activeButtonStyle";
            }
            else
            {
               _loc4_.selected = false;
               _loc4_.mx_internal::getTextField().styleName = _loc4_;
            }
            _loc3_++;
         }
         super.resetNavItems();
      ...
      mx_internal function selectButton(param1:int, param2:Boolean = false, param3:Event = null) : void
      {
         ...
         mx_internal::simulatedClickTriggerEvent = param3;
         _loc4_.dispatchEvent(new MouseEvent(MouseEvent.CLICK));
         mx_internal::simulatedClickTriggerEvent = null;
      }
      ...
      override protected function hiliteSelectedNavItem(param1:int) : void
      {
         ...
         if(selectedIndex != -1 && selectedIndex < numChildren)
         {
            ...
            _loc2_.mx_internal::getTextField().styleName = _loc2_;
         ...
         if(param1 > -1)
         {
            ...
            _loc3_ = getStyle(mx_internal::selectedButtonTextStyleNameProp);
            _loc2_.mx_internal::getTextField().styleName = !!_loc3_ ? _loc3_ : "activeButtonStyle";
            _loc2_.invalidateDisplayList();
         }
      }
      ...
      override protected function keyDownHandler(param1:KeyboardEvent) : void
      {
         ...
         switch(param1.keyCode)
         {
            case Keyboard.PAGE_DOWN:
               _loc2_ = int(mx_internal::nextIndex(selectedIndex));
               break;
            case Keyboard.PAGE_UP:
               if(selectedIndex != -1)
               {
                  _loc2_ = int(mx_internal::prevIndex(selectedIndex));
               }
               else if(_loc4_ > 0)
               {
                  _loc2_ = 0;
            ...
            case Keyboard.ENTER:
               ...
               {
                  _loc2_ = int(mx_internal::focusedIndex);
                  _loc3_ = false;
               }
               break;
            default:
         ...
         if(_loc2_ != -1)
         {
            mx_internal::selectButton(_loc2_,_loc3_,param1);
         }
