   ...
   public class AbstractProducer extends MessageAgent
   {
      ...
      public function set reconnectInterval(param1:int) : void
      {
         ...
         if(_reconnectInterval != param1)
         {
            if(param1 < 0)
            {
               _loc3_ = String(resourceManager.getString("messaging","reconnectIntervalNegative"));
      ...
      public function set priority(param1:int) : void
      {
         ...
         if(_priority != param1)
         {
            ...
            _loc2_ = PropertyChangeEvent.createUpdateEvent(this,"priority",_priority,param1);
            _priority = param1;
            dispatchEvent(_loc2_);
         }
      }
      ...
      public function send(param1:IMessage) : void
      {
         ...
         if(!connected && !autoConnect)
         {
            ...
            mx_internal::internalFault(_loc3_,param1,false,true);
         }
         else
         {
            if(Log.isInfo())
      ...
      {
         mx_internal::internalFault(param1,param2);
      }
