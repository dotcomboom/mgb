package
{
   ...
   public class _DataGridStyle
   {
      ...
      private static var _embed_css_Assets_swf_cursorStretch_1253077724:Class = _DataGridStyle__embed_css_Assets_swf_cursorStretch_1253077724;
      ...
      public static function init(param1:IFlexModuleFactory) : void
      {
         ...
         if(style.defaultFactory == null)
         {
            style.defaultFactory = function():void
            {
               ...
               this.stretchCursor = _embed_css_Assets_swf_cursorStretch_1253077724;
